...
class Elm {
    ...
    // get
    bool importing() C;
    Elm &importing(bool on);
    bool opened() C;
    Elm &opened(bool on);
    bool exists() C;
    Elm &exists(bool on); // this checks only if this element       exists       , it doesn't check the parents
    bool removed() C;
    Elm &removed(bool on); // this checks only if this element is    removed      , it doesn't check the parents
    bool publish() C;
    Elm &publish(bool on); // this checks only if this element is    publish      , it doesn't check the parents
    bool noPublish() C;
    Elm &noPublish(bool on); // this checks only if this element is no publish      , it doesn't check the parents
    bool publishMobile() C;
    Elm &publishMobile(bool on); // this checks only if this element is    publishMobile, it doesn't check the parents
    bool noPublishMobile() C;
    Elm &noPublishMobile(bool on); // this checks only if this element is no publishMobile, it doesn't check the parents
    bool finalRemoved() C;
    Elm &finalRemoved(bool on);
    bool finalExists() C;
    Elm &finalExists(bool on);
    bool finalPublish() C;
    Elm &finalPublish(bool on); // this includes 'finalExists'  and Platform as well !!
    bool finalNoPublish() C;
    Elm &finalNoPublish(bool on); // this includes 'finalRemoved' and Platform as well !!
    C Str &srcFile() C;
    bool initialized() C;
    ...
    ElmObjClass *objClassData();
    C ElmObjClass *objClassData() C;
    ElmObj *objData();
    C ElmObj *objData() C;
    ElmMesh *meshData();
    C ElmMesh *meshData() C;
    ElmMaterial *mtrlData();
    C ElmMaterial *mtrlData() C;
    ElmWaterMtrl *waterMtrlData();
    C ElmWaterMtrl *waterMtrlData() C;
    ElmPhysMtrl *physMtrlData();
    C ElmPhysMtrl *physMtrlData() C;
    ElmSkel *skelData();
    C ElmSkel *skelData() C;
    ElmPhys *physData();
    C ElmPhys *physData() C;
    ElmAnim *animData();
    C ElmAnim *animData() C;
    ElmPanelImage *panelImageData();
    C ElmPanelImage *panelImageData() C;
    ElmEnv *envData();
    C ElmEnv *envData() C;
    ElmWorld *worldData();
    ...
    ElmImage *imageData();
    C ElmImage *imageData() C;
    ElmImageAtlas *imageAtlasData();
    C ElmImageAtlas *imageAtlasData() C;
    ElmIconSetts *iconSettsData();
    C ElmIconSetts *iconSettsData() C;
    ElmIcon *iconData();
    C ElmIcon *iconData() C;
    ElmFont *fontData();
    C ElmFont *fontData() C;
    ElmTextStyle *textStyleData();
    C ElmTextStyle *textStyleData() C;
    ElmPanel *panelData();
    C ElmPanel *panelData() C;
    ElmGuiSkin *guiSkinData();
    C ElmGuiSkin *guiSkinData() C;
    ElmGui *guiData();
    C ElmGui *guiData() C;
    ElmSound *soundData();
    C ElmSound *soundData() C;
    ElmVideo *videoData();
    C ElmVideo *videoData() C;
    ElmFile *fileData();
    C ElmFile *fileData() C;
    ElmCode *codeData();
    C ElmCode *codeData() C;
    ElmApp *appData();
    C ElmApp *appData() C;
    ElmData *Data();
