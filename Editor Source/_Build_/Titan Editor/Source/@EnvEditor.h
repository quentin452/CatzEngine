...
class EnvEditor : ClosableWindow {
    ...
    template <int i>
    static void CloudsColor(EditEnv &env, C Str &text);
    template <int i>
    static Str CloudsColor(C EditEnv &env);
    template <int i>
    static void CloudsScale(EditEnv &env, C Str &text);
    template <int i>
    static Str CloudsScale(C EditEnv &env);
    template <int i>
    static void CloudsVel(EditEnv &env, C Str &text);
    template <int i>
    static Str CloudsVel(C EditEnv &env);
    template <int i>
    static void CloudsImage(EditEnv &env, C Str &text);
    template <int i>
    static Str CloudsImage(C EditEnv &env);
