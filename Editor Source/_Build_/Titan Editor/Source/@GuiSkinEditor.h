...
class GuiSkinEditor : Region {
    ...
    class Objs {
        class ButtonPushed : Button {
            virtual void update(C GuiPC &gpc) override;
        };
        class CheckBoxOff : CheckBox {
            virtual void update(C GuiPC &gpc) override;
        };
        class CheckBoxOn : CheckBox {
            virtual void update(C GuiPC &gpc) override;
        };
        class CheckBoxMulti : CheckBox {
            virtual void update(C GuiPC &gpc) override;
        };
        class ComboBoxPushed : ComboBox {
            virtual void draw(C GuiPC &gpc) override;
        };
        class WindowActive : Window {
            virtual void draw(C GuiPC &gpc) override;
        };
