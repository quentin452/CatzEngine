...
class GuiView : Region {
    ...
    class Button2 : GuiObjs::ObjName<Button> {
        ~Button2();
        Button2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class CheckBox2 : GuiObjs::ObjName<CheckBox> {
        ~CheckBox2();
        CheckBox2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
        virtual void update(C GuiPC &gpc) override;
    };
    class ComboBox2 : GuiObjs::ObjName<ComboBox> {
        ~ComboBox2();
        ComboBox2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
        virtual void update(C GuiPC &gpc) override;
    ...
    class Desktop2 : GuiObjs::ObjName<Desktop> {
        ~Desktop2();
        Desktop2(); /*virtual GuiObj* test(C Vec2 &pos, GuiObj* &mouse_wheel)override {return (IgnoreSelected && GuiEdit.sel.has(this)) ? null : super.test(pos, mouse_wheel);}*/
    };
    class GuiImage2 : GuiObjs::ObjName<GuiImage> {
        ~GuiImage2();
        GuiImage2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class List2 : GuiObjs::ObjName<_List> {
        ~List2();
        List2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class Menu2 : GuiObjs::ObjName<Menu> {
        ~Menu2();
        Menu2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class MenuBar2 : GuiObjs::ObjName<MenuBar> {
        ~MenuBar2();
        MenuBar2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class Progress2 : GuiObjs::ObjName<Progress> {
        ~Progress2();
        Progress2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class Region2 : GuiObjs::ObjName<Region> {
        ~Region2();
        Region2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class SlideBar2 : GuiObjs::ObjName<SlideBar> {
        ~SlideBar2();
        SlideBar2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class Slider2 : GuiObjs::ObjName<Slider> {
        ~Slider2();
        Slider2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class Tabs2 : GuiObjs::ObjName<Tabs> {
        ~Tabs2();
        Tabs2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
    };
    class Text2 : GuiObjs::ObjName<Text> {
        ~Text2();
        Text2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
        virtual void draw(C GuiPC &gpc) override;
    };
    class TextBox2 : GuiObjs::ObjName<TextBox> {
        ~TextBox2();
        TextBox2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
        virtual void update(C GuiPC &gpc) override;
    ...
    class TextLine2 : GuiObjs::ObjName<TextLine> {
        ~TextLine2();
        TextLine2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
        virtual void update(C GuiPC &gpc) override;
    ...
    class Viewport2 : GuiObjs::ObjName<Viewport> {
        ~Viewport2();
        Viewport2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
        virtual void draw(C GuiPC &gpc) override;
    };
    class Window2 : GuiObjs::ObjName<Window> {
        ~Window2();
        Window2();
        virtual GuiObj *test(C GuiPC &gpc, C Vec2 &pos, GuiObj *&mouse_wheel) override;
        virtual void update(C GuiPC &gpc) override;
    ...
    template <int i>
    static Str TabsTabText(C Tabs &tabs);
    template <int i>
    static void TabsTabText(Tabs &tabs, C Str &t);
    ...
    void sort();
    static int CompareOrder(GuiObj *C &a, GuiObj *C &b);
    void alignSel();
