...
class ObjView : Viewport4Region {
    ...
    Menu menu;
    Memc<UID> menu_ids;
    Edit::Undo<MeshChange> mesh_undos;
    bool mesh_undos_undo;
    Edit::Undo<PhysChange> phys_undos;
    void undoVis();
    ...
    static void MeshDelete(ObjView &editor);
    void meshDelete();
    static void MeshSplit(ObjView &editor);
    void meshSplit();
    static void MeshAlignXZ(ObjView &editor);
    void meshAlign(bool xz);
    static void MeshAlign(ObjView &editor);
    static void MeshWeldPos(ObjView &editor);
    void meshWeldPos();
    void meshWeldPos(flt pos_eps);
    static void MeshSetPos(ObjView &editor);
    static void MeshSetPosKeepUV(ObjView &editor);
    void meshSetPos(bool keep_uv);
    static void MeshReverse(ObjView &editor);
    void meshReverse();
    static void MeshReverseNrm(ObjView &editor);
    void meshReverseNrm();
    static void MeshSetNormalFa(ObjView &editor);
    void meshSetNrmFace();
    static void MeshSetNormalN(ObjView &editor);
    void meshSetNrm(MESH_FLAG vtx_test);
    ...
    static void MeshCopyNormal(ObjView &editor);
    void meshCopyNrm();
    static void MeshNormalY(ObjView &editor);
    void meshNrmY();
    static void MeshSetVtxAO(ObjView &editor);
    static void MeshCreateFace(ObjView &editor);
    void meshCreateFace();
    static void MeshMergeFaces(ObjView &editor);
    void meshMergeFaces();
    static void MeshMergeCopFaces(ObjView &editor);
    void meshMergeCoplanarFaces(bool all);
    static void MeshRotQuads(ObjView &editor);
    void meshRotQuads();
    static void MeshQuadToTri(ObjView &editor);
    void meshQuadToTri();
    static void MeshTriToQuad(ObjView &editor);
    void meshTriToQuad();
    static void MeshTesselate(ObjView &editor);
    void meshTesselate();
    static void MeshSubdivide(ObjView &editor);
    void meshSubdivide();
    static void MeshColorBrghtn(ObjView &editor);
    void meshColorBrghtn();
    static void MeshColorDarken(ObjView &editor);
    void meshColorDarken();
    static void MeshDelDblSide(ObjView &editor);
    void meshDelDblSide();
    static void MeshCopyLods(ObjView &editor);
    void meshCopyLods();
    static void MeshReplaceLods(ObjView &editor);
    void meshReplaceLods();
    static void MeshSeparate1(ObjView &editor);
    void meshSeparate1();
    static void MeshSeparateN(ObjView &editor);
    void meshSeparateN();
    static void MeshCopyParts(ObjView &editor);
    void meshCopyParts();
    static void SetBody(ObjView &editor);
    static void AnimTargetObj(ObjView &editor);
    static void MeshSkinFull(ObjView &editor);
    void meshSkinFull();
    static void MeshSkinFullP(ObjView &editor);
    void meshSkinFullP();
    static void MeshSkinFullU(ObjView &editor);
    void meshSkinFullU();
    static void MeshSkinAuto(ObjView &editor);
    void meshSkinAuto();
    ...
    static void MeshDisableLQLODs(ObjView &editor);
    void meshDisableLQLODs();
