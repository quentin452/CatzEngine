...
class PanelImageEditor : PropWin {
    ...
    template <int i>
    static void LightEnabled(Params &p, C Str &t);
    template <int i>
    static void LightAngle(Params &p, C Str &t);
    template <int i>
    static void LightIntensity(Params &p, C Str &t);
    template <int i>
    static void LightBack(Params &p, C Str &t);
    template <int i>
    static void LightHighlight(Params &p, C Str &t);
    template <int i>
    static void LightHighlightCut(Params &p, C Str &t);
    template <int i>
    static void LightSpecular(Params &p, C Str &t);
    template <int i>
    static void LightSpecularBack(Params &p, C Str &t);
    template <int i>
    static void LightSpecularExp(Params &p, C Str &t);
    template <int i>
    static void LightSpecularHighlight(Params &p, C Str &t);
    template <int i>
    static void LightSpecularHighlightCut(Params &p, C Str &t);

    template <int i>
    static void SectionSize(Params &p, C Str &t);
    template <int i>
    static void SectionTopOffset(Params &p, C Str &t);

    template <int i>
    static void SectionRoundDepth(Params &p, C Str &t);
    template <int i>
    static void SectionOuterDepth(Params &p, C Str &t);
    template <int i>
    static void SectionInnerDepth(Params &p, C Str &t);
    template <int i>
    static void SectionInnerDistance(Params &p, C Str &t);
    template <int i>
    static void SectionSmoothDepth(Params &p, C Str &t);

    template <int i>
    static void SectionSpecular(Params &p, C Str &t);
    template <int i>
    static void SectionColor(Params &p, C Str &t);
    template <int i>
    static void SectionOuterColor(Params &p, C Str &t);
    template <int i>
    static void SectionInnerColor(Params &p, C Str &t);
    template <int i>
    static void SectionColorTop(Params &p, C Str &t);
    template <int i>
    static void SectionColorBottom(Params &p, C Str &t);
    template <int i>
    static void SectionColorLeft(Params &p, C Str &t);
    template <int i>
    static void SectionColorRight(Params &p, C Str &t);
    template <int i>
    static void SectionOuterBorderColor(Params &p, C Str &t);
    template <int i>
    static void SectionInnerBorderColor(Params &p, C Str &t);
    template <int i>
    static void SectionPrevBorderColor(Params &p, C Str &t);

    template <int i>
    static Str SectionDepthOverlay(C Params &p);
    template <int i>
    static void SectionDepthOverlay(Params &p, C Str &t);
    template <int i>
    static void SectionDepthOverlayBlur(Params &p, C Str &t);
    template <int i>
    static void SectionDepthOverlayBlurClamp(Params &p, C Str &t);
    template <int i>
    static void SectionDepthOverlayUVScale(Params &p, C Str &t);
    template <int i>
    static void SectionDepthOverlayUVOffset(Params &p, C Str &t);
    template <int i>
    static void SectionDepthOverlayIntensity(Params &p, C Str &t);
    template <int i>
    static void SectionDepthOverlayMode(Params &p, C Str &t);

    template <int i>
    static void SectionDepthNoiseBlur(Params &p, C Str &t);
    template <int i>
    static void SectionDepthNoiseUVScale(Params &p, C Str &t);
    template <int i>
    static void SectionDepthNoiseIntensity(Params &p, C Str &t);
    template <int i>
    static void SectionDepthNoiseMode(Params &p, C Str &t);

    template <int i>
    static Str SectionColorOverlay(C Params &p);
    template <int i>
    static void SectionColorOverlay(Params &p, C Str &t);
    template <int i>
    static void SectionColorOverlayBlur(Params &p, C Str &t);
    template <int i>
    static void SectionColorOverlayBlurClamp(Params &p, C Str &t);
    template <int i>
    static void SectionColorOverlayUVScale(Params &p, C Str &t);
    template <int i>
    static void SectionColorOverlayUVOffset(Params &p, C Str &t);
    template <int i>
    static void SectionColorOverlayUVWarp(Params &p, C Str &t);
    template <int i>
    static void SectionColorOverlayIntensity(Params &p, C Str &t);
    template <int i>
    static void SectionColorOverlayMode(Params &p, C Str &t);

    template <int i>
    static void SectionColorNoiseBlur(Params &p, C Str &t);
    template <int i>
    static void SectionColorNoiseUVScale(Params &p, C Str &t);
    template <int i>
    static void SectionColorNoiseUVWarp(Params &p, C Str &t);
    template <int i>
    static void SectionColorNoiseIntensity(Params &p, C Str &t);
    template <int i>
    static void SectionColorNoiseMode(Params &p, C Str &t);

    template <int i>
    static Str SectionReflection(C Params &p);
    template <int i>
    static void SectionReflection(Params &p, C Str &t);
    template <int i>
    static void SectionReflectionIntensity(Params &p, C Str &t);
