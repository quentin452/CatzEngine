...
class PathProps : Region {
    ...
    static void CellSize(PathProps &pp, C Str &text);
    static Str CellSize(C PathProps &pp);
    static void CtrlRadius(PathProps &pp, C Str &text);
    static Str CtrlRadius(C PathProps &pp);
    static void CtrlHeight(PathProps &pp, C Str &text);
    static Str CtrlHeight(C PathProps &pp);
    static void MaxSlope(PathProps &pp, C Str &text);
    static Str MaxSlope(C PathProps &pp);
    static void MaxClimb(PathProps &pp, C Str &text);
    static Str MaxClimb(C PathProps &pp);
