...
class Viewport4Region : Region {
    ...
    void setMoveMenu();
    void setZoomMenu();
    void moveMode(Edit::Viewport4::MOVE_MODE mode);
    void toggleMoveMode(Edit::Viewport4::MOVE_MODE mode);
    void orientMode(Edit::Viewport4::ORIENT_MODE mode);
    void toggleOrientMode(Edit::Viewport4::ORIENT_MODE mode);
    void zoom(bool on);
    void toggleZoom();
