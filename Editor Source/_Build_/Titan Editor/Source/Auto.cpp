...
#define OPEN_VR 0 // if Application properties have OpenVR enabled     \
                  // this is set to true when compiling for publishing \
                  // this is set to true when "Embed Engine Data" was enabled in application settings, this is always disabled for WindowsNew, Mobile and Web builds
cchar *C ENGINE_DATA_PATH = ((WINDOWS_NEW || MOBILE || WEB) ? u"Engine.pak" : PUBLISH ? u"Bin/Engine.pak"
                                                                                      : u"C:/Esenthel/Editor/Bin/Engine.pak");
cchar *C PROJECT_DATA_PATH = ((WINDOWS_NEW || MOBILE || WEB) ? u"Project.pak" : PUBLISH ? u"Bin/Project.pak"
                                                                                        : u"C:/Esenthel/Editor Source/h3kv^1fvcwe4ri0#ll#761m7/Game");
...
void INIT(bool load_engine_data, bool load_project_data) {
    ...
    {
        if (WINDOWS_NEW || MOBILE || WEB || PUBLISH)
