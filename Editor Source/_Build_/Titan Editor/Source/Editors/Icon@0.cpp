...
void IconSettsEditor::Width(IconSettsEditor &ie, C Str &t) {
    int i = TextInt(t);
    ie.edit.width = (InRange(i, IconSizes) ? TextInt(IconSizes[i]) : 128);
    ie.edit.width_time.getUTC();
}
Str IconSettsEditor::Width(C IconSettsEditor &ie) {
    int nearest = -1, dist;
    REPA(IconSizes) {
        int d = Abs(ie.edit.width - TextInt(IconSizes[i]));
        if (nearest < 0 || d < dist) {
            nearest = i;
            dist = d;
        }
...
void IconSettsEditor::Height(IconSettsEditor &ie, C Str &t) {
    int i = TextInt(t);
    ie.edit.height = (InRange(i, IconSizes) ? TextInt(IconSizes[i]) : 128);
    ie.edit.height_time.getUTC();
}
Str IconSettsEditor::Height(C IconSettsEditor &ie) {
    int nearest = -1, dist;
    REPA(IconSizes) {
        int d = Abs(ie.edit.height - TextInt(IconSizes[i]));
        if (nearest < 0 || d < dist) {
            nearest = i;
            dist = d;
        }
...
void IconSettsEditor::Type(IconSettsEditor &ie, C Str &t) {
    int i = TextInt(t);
    if (InRange(i, ElmImage::NUM))
        ie.edit.type = ElmImage::TYPE(i);
    ie.edit.type_time.getUTC();
}
Str IconSettsEditor::Type(C IconSettsEditor &ie) { return ie.edit.type; }
void IconSettsEditor::MipMaps(IconSettsEditor &ie, C Str &t) {
    ie.edit.mip_maps = TextBool(t);
    ie.edit.mip_maps_time.getUTC();
}
Str IconSettsEditor::MipMaps(C IconSettsEditor &ie) { return ie.edit.mip_maps; }
void IconSettsEditor::AutoCenter(IconSettsEditor &ie, C Str &t) {
    ie.edit.auto_center = TextBool(t);
    ie.edit.auto_center_time.getUTC();
}
Str IconSettsEditor::AutoCenter(C IconSettsEditor &ie) { return ie.edit.auto_center; }
void IconSettsEditor::Scale(IconSettsEditor &ie, C Str &t) {
    ie.edit.scale = TextFlt(t);
    ie.edit.scale_time.getUTC();
}
Str IconSettsEditor::Scale(C IconSettsEditor &ie) { return ie.edit.scale; }
void IconSettsEditor::CamYaw(IconSettsEditor &ie, C Str &t) {
    ie.edit.cam_angle.x = DegToRad(TextFlt(t));
    ie.edit.cam_angle_time.getUTC();
}
Str IconSettsEditor::CamYaw(C IconSettsEditor &ie) { return RadToDeg(ie.edit.cam_angle.x); }
void IconSettsEditor::CamPitch(IconSettsEditor &ie, C Str &t) {
    ie.edit.cam_angle.y = DegToRad(TextFlt(t));
    ie.edit.cam_angle_time.getUTC();
}
Str IconSettsEditor::CamPitch(C IconSettsEditor &ie) { return RadToDeg(ie.edit.cam_angle.y); }
void IconSettsEditor::CamRoll(IconSettsEditor &ie, C Str &t) {
    ie.edit.cam_angle.z = DegToRad(TextFlt(t));
    ie.edit.cam_angle_time.getUTC();
}
Str IconSettsEditor::CamRoll(C IconSettsEditor &ie) { return RadToDeg(ie.edit.cam_angle.z); }
void IconSettsEditor::CamFocusX(IconSettsEditor &ie, C Str &t) {
    ie.edit.cam_focus.x = TextFlt(t);
    ie.edit.cam_focus_time.getUTC();
}
Str IconSettsEditor::CamFocusX(C IconSettsEditor &ie) { return ie.edit.cam_focus.x; }
void IconSettsEditor::CamFocusY(IconSettsEditor &ie, C Str &t) {
    ie.edit.cam_focus.y = TextFlt(t);
    ie.edit.cam_focus_time.getUTC();
}
Str IconSettsEditor::CamFocusY(C IconSettsEditor &ie) { return ie.edit.cam_focus.y; }
void IconSettsEditor::CamFocusZ(IconSettsEditor &ie, C Str &t) {
    ie.edit.cam_focus.z = TextFlt(t);
    ie.edit.cam_focus_time.getUTC();
}
Str IconSettsEditor::CamFocusZ(C IconSettsEditor &ie) { return ie.edit.cam_focus.z; }
void IconSettsEditor::BloomOriginal(IconSettsEditor &ie, C Str &t) {
    ie.edit.bloom_original = TextFlt(t);
    ie.edit.bloom_original_time.getUTC();
}
Str IconSettsEditor::BloomOriginal(C IconSettsEditor &ie) { return ie.edit.bloom_original; }
void IconSettsEditor::BloomScale(IconSettsEditor &ie, C Str &t) {
    ie.edit.bloom_scale = TextFlt(t);
    ie.edit.bloom_scale_time.getUTC();
}
Str IconSettsEditor::BloomScale(C IconSettsEditor &ie) { return ie.edit.bloom_scale; }
void IconSettsEditor::BloomCut(IconSettsEditor &ie, C Str &t) {
    ie.edit.bloom_cut = TextFlt(t);
    ie.edit.bloom_cut_time.getUTC();
}
Str IconSettsEditor::BloomCut(C IconSettsEditor &ie) { return ie.edit.bloom_cut; }
void IconSettsEditor::BloomGlow(IconSettsEditor &ie, C Str &t) {
    ie.edit.bloom_glow = TextFlt(t);
    ie.edit.bloom_glow_time.getUTC();
}
Str IconSettsEditor::BloomGlow(C IconSettsEditor &ie) { return ie.edit.bloom_glow; }
void IconSettsEditor::Light0Shadow(IconSettsEditor &ie, C Str &t) {
    ie.edit.light0_shadow = TextBool(t);
    ie.edit.light0_shadow_time.getUTC();
}
Str IconSettsEditor::Light0Shadow(C IconSettsEditor &ie) { return ie.edit.light0_shadow; }
void IconSettsEditor::Light1Shadow(IconSettsEditor &ie, C Str &t) {
    ie.edit.light1_shadow = TextBool(t);
    ie.edit.light1_shadow_time.getUTC();
}
Str IconSettsEditor::Light1Shadow(C IconSettsEditor &ie) { return ie.edit.light1_shadow; }
void IconSettsEditor::AmbientCol(IconSettsEditor &ie, C Str &t) {
    ie.edit.ambient_col = TextVec(t);
    ie.edit.ambient_col_time.getUTC();
}
Str IconSettsEditor::AmbientCol(C IconSettsEditor &ie) { return ie.edit.ambient_col; }
void IconSettsEditor::AmbientOccl(IconSettsEditor &ie, C Str &t) {
    ie.edit.ambient_occl = TextFlt(t);
    ie.edit.ambient_occl_time.getUTC();
}
Str IconSettsEditor::AmbientOccl(C IconSettsEditor &ie) { return ie.edit.ambient_occl; }
void IconSettsEditor::AmbientRange(IconSettsEditor &ie, C Str &t) {
    ie.edit.ambient_range = TextFlt(t);
    ie.edit.ambient_range_time.getUTC();
}
Str IconSettsEditor::AmbientRange(C IconSettsEditor &ie) { return ie.edit.ambient_range; }
void IconSettsEditor::Light0Col(IconSettsEditor &ie, C Str &t) {
    ie.edit.light0_col = TextVec(t);
    ie.edit.light0_col_time.getUTC();
}
Str IconSettsEditor::Light0Col(C IconSettsEditor &ie) { return ie.edit.light0_col; }
void IconSettsEditor::Light0Yaw(IconSettsEditor &ie, C Str &t) {
    ie.edit.light0_angle.x = DegToRad(TextFlt(t));
    ie.edit.light0_angle_time.getUTC();
}
Str IconSettsEditor::Light0Yaw(C IconSettsEditor &ie) { return RadToDeg(ie.edit.light0_angle.x); }
void IconSettsEditor::Light0Pitch(IconSettsEditor &ie, C Str &t) {
    ie.edit.light0_angle.y = DegToRad(TextFlt(t));
    ie.edit.light0_angle_time.getUTC();
}
Str IconSettsEditor::Light0Pitch(C IconSettsEditor &ie) { return RadToDeg(ie.edit.light0_angle.y); }
void IconSettsEditor::Light1Col(IconSettsEditor &ie, C Str &t) {
    ie.edit.light1_col = TextVec(t);
    ie.edit.light1_col_time.getUTC();
}
Str IconSettsEditor::Light1Col(C IconSettsEditor &ie) { return ie.edit.light1_col; }
void IconSettsEditor::Light1Yaw(IconSettsEditor &ie, C Str &t) {
    ie.edit.light1_angle.x = DegToRad(TextFlt(t));
    ie.edit.light1_angle_time.getUTC();
}
Str IconSettsEditor::Light1Yaw(C IconSettsEditor &ie) { return RadToDeg(ie.edit.light1_angle.x); }
void IconSettsEditor::Light1Pitch(IconSettsEditor &ie, C Str &t) {
    ie.edit.light1_angle.y = DegToRad(TextFlt(t));
    ie.edit.light1_angle_time.getUTC();
}
Str IconSettsEditor::Light1Pitch(C IconSettsEditor &ie) { return RadToDeg(ie.edit.light1_angle.y); }
void IconSettsEditor::Fov(IconSettsEditor &ie, C Str &t) {
    ie.edit.fov = DegToRad(TextFlt(t));
    ie.edit.fov_time.getUTC();
}
...
void IconSettsEditor::create() {
    ...
    super::create("Icon Settings Editor", Vec2(0.02f, -0.07f), 0.036f, 0.043f, 0.28f);
...
IconSettsEditor &IconSettsEditor::hide() {
    set(null);
    super::hide();
    return T;
}
...
void IconSettsEditor::setChanged() {
    if (elm) {
        ...
        if (ElmIcon *icon = IconEdit.data())
            if (icon->icon_settings_id == elm_id)
                IconEdit.settings = edit;
    }
}
void IconSettsEditor::set(Elm *elm) {
    if (elm && elm->type != ELM_ICON_SETTS)
        elm = null;
    if (T.elm != elm) {
        flush();
        undos.del();
...
void IconSettsEditor::activate(Elm *elm) {
    set(elm);
    if (T.elm)
        super::activate();
}
void IconSettsEditor::toggle(Elm *elm) {
    if (elm == T.elm)
        elm = null;
    set(elm);
}
void IconSettsEditor::erasing(C UID &elm_id) {
...
flt IconEditor::getDist() // !! assumes that viewport and obj are already set !!
{
    if (!settings.auto_center)
        return 1; // we need constant camera distance when auto centering is disabled
    return GetDist(box());
}
...
void IconEditor::draw(bool final) {
    ...
    BUMP_MODE bump = D.bumpMode();
    if (final)
        D.bumpMode(BUMP_RELIEF);
    EDGE_SOFTEN_MODE edge = D.edgeSoften();
    D.edgeSoften(EDGE_SOFTEN_SMAA);
    SHADOW_MODE shadow = D.shadowMode();
    D.shadowMode(SHADOW_MAP);
    Vec ambient_col_l = D.ambientColorL();
    D.ambientColorS(settings.ambient_col);
    flt ambient_contr = D.ambientContrast();
    D.ambientContrast(settings.ambient_occl);
    flt ambient_range = D.ambientRange();
    D.ambientRange(settings.ambient_range);
    ...
    Skeleton *skel = null;
    if (T.obj)
        if (C MeshPtr &mesh = T.obj->mesh()) {
            skel = mesh->skeleton();
            if (data)
                mesh_variation = ((data->variation_id == ElmIcon::InheritVariation) ? obj->meshVariationIndex() : mesh->variationFind(data->variation_id));
        }
    if (T.skel.skeleton() != skel || skel && skel->bones.elms() != T.skel.bones.elms()) {
        T.skel.create(skel);
        T.skel_anim.del();
    }
    ::Animation *anim = null;
    if (data)
        if (data->anim_id.valid())
            anim = Animations(Proj.gamePath(data->anim_id));
    ...
    T.skel.updateBegin().clear().animate(skel_anim, time).animateRoot(anim, time).updateMatrix(matrix()).updateEnd();
    T.skel.updateBegin().updateEnd(); // 'updateBegin,updateEnd' twice to remove motion blur
    ...
    if (final) {
        ...
        view_size = size;
        VecI2 screen_size(D.resW(), D.resH());
        if (view_size.x > screen_size.x)
            view_size = Round(view_size * (flt(screen_size.x) / view_size.x)); // fit X
        if (view_size.y > screen_size.y)
            view_size = Round(view_size * (flt(screen_size.y) / view_size.y)); // fit Y
        REP(8)                                                                 // super sample
        {
            VecI2 super_size = view_size * 2;
            if (super_size.x <= screen_size.x && super_size.y <= screen_size.y)
                view_size = super_size;
            else
                break;
        }
        ...
        if (view_size.x > rect_size.x)
            view_size *= rect_size.x / view_size.x; // fit X
        if (view_size.y > rect_size.y)
            view_size *= rect_size.y / view_size.y; // fit Y
    ...
    if (!final)
        Renderer(IconEditor::Render);
    else if (data) {
        Image col, soft;
        D.edgeSoften(EDGE_SOFTEN_NONE);
        Renderer(IconEditor::Render);
        Renderer.capture(col, -1, -1, IMAGE_R8G8B8A8_SRGB, IMAGE_SOFT, 1, true);
        D.edgeSoften(EDGE_SOFTEN_SMAA);
        Renderer(IconEditor::Render);
        Renderer.capture(soft, -1, -1, IMAGE_R8G8B8A8_SRGB, IMAGE_SOFT, 1, false); // skip alpha for 'soft' to improve performance
        ...
        REPD(x, col.w()) {
                    ...
                    for (int sy = y - 1; sy <= y + 1; sy++)
                        if (InRange(sy, col.h()))
                            for (int sx = x - 1; sx <= x + 1; sx++)
                                if (InRange(sx, col.w()))
                                    if (sx || sy)
                                        if (!soft.color(sx, sy).a) // if at least one neighbor is transparent (so we won't adjust opacity of softened pixels which are "inside" the object)
                                        {
            ...
            } else // transparent
            {
                    ...
                    for (int sy = y - 1; sy <= y + 1; sy++)
                        if (InRange(sy, col.h()))
                            for (int sx = x - 1; sx <= x + 1; sx++)
                                if (InRange(sx, col.w()))
                                    if (sx || sy) {
                                        Color n = soft.color(sx, sy);
                                        if (n.a) // fully opaque neighbor
                                        {
                                            MAX(c_lum, n.lum());
                                        }
                                    }
                ...
                } else if (c_lum) // bloom blur / blend material
                {
                    c.a = c_lum;
...
void IconEditor::Object(IconEditor &ie, C Str &text) {
    if (ElmIcon *data = ie.data()) {
        data->obj_id = Proj.findElmID(text, ELM_OBJ);
        data->obj_time.getUTC();
        ie.meshVariationChanged();
    }
}
Str IconEditor::Object(C IconEditor &ie) {
    if (ElmIcon *data = ie.data())
        return Proj.elmFullName(data->obj_id);
    return S;
}
void IconEditor::Variation(IconEditor &ie, C Str &text) {
    if (ElmIcon *data = ie.data())
        if (ie.var) {
            data->variation_id = (InRange(ie.var->combobox(), ie.mesh_variations) ? ie.mesh_variations[ie.var->combobox()].id : ElmIcon::InheritVariation);
            data->variation_time.getUTC();
        }
}
Str IconEditor::Variation(C IconEditor &ie) {
    if (ElmIcon *data = ie.data())
        REPA(ie.mesh_variations)
    if (data->variation_id == ie.mesh_variations[i].id)
        return i;
    return S;
}
void IconEditor::Settings(IconEditor &ie, C Str &text) {
    if (ElmIcon *data = ie.data()) {
        data->icon_settings_id = Proj.findElmID(text, ELM_ICON_SETTS);
        data->icon_settings_time.getUTC();
        ie.reloadSettings();
    }
}
Str IconEditor::Settings(C IconEditor &ie) {
    if (ElmIcon *data = ie.data())
        return Proj.elmFullName(data->icon_settings_id);
    return S;
}
void IconEditor::Animation(IconEditor &ie, C Str &text) {
    if (ElmIcon *data = ie.data()) {
        data->anim_id = Proj.findElmID(text, ELM_ANIM);
        data->anim_id_time.getUTC();
    }
}
Str IconEditor::Animation(C IconEditor &ie) {
    if (ElmIcon *data = ie.data())
        return Proj.elmFullName(data->anim_id);
    return S;
}
void IconEditor::AnimPos(IconEditor &ie, C Str &text) {
    if (ElmIcon *data = ie.data()) {
        data->anim_pos = TextFlt(text);
        data->anim_pos_time.getUTC();
    }
}
Str IconEditor::AnimPos(C IconEditor &ie) {
    if (ElmIcon *data = ie.data())
        return data->anim_pos;
    return S;
}
...
void IconEditor::create() {
    ...
    flt h = 0.043f;
    Rect r = super::create("Icon Editor", Vec2(0.02f, -0.07f), 0.036f, h, PropElmNameWidth);
    super::changed(Changed, PreChanged);
    nos->changed(null, null);
    T += undo.create(Rect_LU(0.02f, -0.01f, 0.05f, 0.05f)).func(Undo, T).focusable(false).desc("Undo");
    undo.image = "Gui/Misc/undo.img";
    T += redo.create(Rect_LU(undo.rect().ru(), 0.05f, 0.05f)).func(Redo, T).focusable(false).desc("Redo");
    redo.image = "Gui/Misc/redo.img";
...
void IconEditor::toGui() {
    meshVariationChanged();
    super::toGui();
}
IconEditor &IconEditor::hide() {
    set(null);
    super::hide();
    return T;
}
Rect IconEditor::sizeLimit() C {
    Rect r = super::sizeLimit();
    r.min.set(0.75f, 0.45f);
    return r;
}
...
void IconEditor::reloadSettings() {
    UID settings_id = UIDZero;
    if (ElmIcon *data = T.data())
        settings_id = data->icon_settings_id;
    if (!settings_id.valid())
        settings.reset();
    else if (IconSettsEdit.elm_id == settings_id)
        settings = IconSettsEdit.edit;
    else
        settings.load(Proj.editPath(settings_id));
}
void IconEditor::set(Elm *elm) {
    if (elm && elm->type != ELM_ICON)
        elm = null;
    if (T.elm != elm) {
        flush();
        undos.del();
...
void IconEditor::activate(Elm *elm) {
    set(elm);
    if (T.elm)
        super::activate();
}
void IconEditor::toggle(Elm *elm) {
    if (elm == T.elm)
        elm = null;
    set(elm);
}
void IconEditor::elmChanged(C UID &elm_id) {
    if (elm) {
        ...
        if (ElmIcon *data = T.data()) {
            if (data->icon_settings_id == elm_id)
                reloadSettings();
            if (data->anim_id == elm_id)
                skel_anim.del();
        }
    }
}
void IconEditor::erasing(C UID &elm_id) {
    if (elm && elm->id == elm_id)
        set(null);
}
