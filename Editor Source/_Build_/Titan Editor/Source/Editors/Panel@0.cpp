...
void PanelEditor::GuiPanel::draw(C GuiPC &gpc) {
    if (gpc.visible && visible()) {
        ...
        if (PanelEdit.game) {
            ...
            if (PanelEdit.show_lines()) {
                PanelEdit.game->drawLines(RED, r);
                r.draw(BLACK, false);
            }
        }
    }
...
void PanelEditor::ParamsCenterStretch(EditPanel &e, C Str &t) {
    e.center_stretch = TextBool(t);
    e.center_stretch_time.getUTC();
}
void PanelEditor::ParamsCenterColor(EditPanel &e, C Str &t) {
    e.center_color = TextVec4(t);
    e.center_color_time.getUTC();
}
void PanelEditor::ParamsBarColor(EditPanel &e, C Str &t) {
    e.bar_color = TextVec4(t);
    e.bar_color_time.getUTC();
}
void PanelEditor::ParamsBorderColor(EditPanel &e, C Str &t) {
    e.border_color = TextVec4(t);
    e.border_color_time.getUTC();
}
void PanelEditor::ParamsSideColor(EditPanel &e, C Str &t) {
    e.side_color = TextVec4(t);
    e.side_color_time.getUTC();
}
void PanelEditor::ParamsBlurColor(EditPanel &e, C Str &t) {
    e.blur_color = TextVec4(t);
    e.blur_color_time.getUTC();
    e.blur_color.a = 0;
}
void PanelEditor::ParamsShadowOpacity(EditPanel &e, C Str &t) {
    e.shadow_opacity = TextInt(t);
    e.shadow_opacity_time.getUTC();
}
void PanelEditor::ParamsShadowRadius(EditPanel &e, C Str &t) {
    e.shadow_radius = TextFlt(t);
    e.shadow_radius_time.getUTC();
}
void PanelEditor::ParamsShadowOffset(EditPanel &e, C Str &t) {
    e.shadow_offset = TextFlt(t);
    e.shadow_offset_time.getUTC();
}
void PanelEditor::ParamsShadowCenter(EditPanel &e, C Str &t) {
    e.center_shadow = TextBool(t);
    e.center_shadow_time.getUTC();
}
void PanelEditor::ParamsSideMode(EditPanel &e, C Str &t) {
    e.side_mode = (Panel::SIDE_MODE)TextInt(t);
    e.side_mode_time.getUTC();
}
void PanelEditor::ParamsCenterScale(EditPanel &e, C Str &t) {
    e.center_scale = TextFlt(t);
    e.center_scale_time.getUTC();
}
void PanelEditor::ParamsBarSize(EditPanel &e, C Str &t) {
    e.bar_size = TextFlt(t);
    e.bar_size_time.getUTC();
}
void PanelEditor::ParamsBorderSize(EditPanel &e, C Str &t) {
    e.border_size = TextFlt(t);
    e.border_size_time.getUTC();
}
void PanelEditor::ParamsSideMinScale(EditPanel &e, C Str &t) {
    e.side_min_scale = TextFlt(t);
    e.side_min_scale_time.getUTC();
}
void PanelEditor::ParamsTopSize(EditPanel &e, C Str &t) {
    e.top_size = TextFlt(t);
    e.top_size_time.getUTC();
}
void PanelEditor::ParamsTopOffset(EditPanel &e, C Str &t) {
    e.top_offset = TextFlt(t);
    e.top_offset_time.getUTC();
}
void PanelEditor::ParamsBottomSize(EditPanel &e, C Str &t) {
    e.bottom_size = TextFlt(t);
    e.bottom_size_time.getUTC();
}
void PanelEditor::ParamsBottomOffset(EditPanel &e, C Str &t) {
    e.bottom_offset = TextFlt(t);
    e.bottom_offset_time.getUTC();
}
void PanelEditor::ParamsLeftRightSize(EditPanel &e, C Str &t) {
    e.left_right_size = TextFlt(t);
    e.left_right_size_time.getUTC();
}
void PanelEditor::ParamsLeftRightOffset(EditPanel &e, C Str &t) {
    e.left_right_offset = TextVec2(t);
    e.left_right_offset_time.getUTC();
}
void PanelEditor::ParamsTopCornerSize(EditPanel &e, C Str &t) {
    e.top_corner_size = TextFlt(t);
    e.top_corner_size_time.getUTC();
}
void PanelEditor::ParamsTopCornerOffset(EditPanel &e, C Str &t) {
    e.top_corner_offset = TextVec2(t);
    e.top_corner_offset_time.getUTC();
}
void PanelEditor::ParamsBottomCornerSize(EditPanel &e, C Str &t) {
    e.bottom_corner_size = TextFlt(t);
    e.bottom_corner_size_time.getUTC();
}
void PanelEditor::ParamsBottomCornerOffset(EditPanel &e, C Str &t) {
    e.bottom_corner_offset = TextVec2(t);
    e.bottom_corner_offset_time.getUTC();
}
...
void PanelEditor::ParamsCenterImage(EditPanel &e, C Str &t) {
    e.center_image = Proj.findElmImageID(t);
    e.center_image_time.getUTC();
}
void PanelEditor::ParamsBarImage(EditPanel &e, C Str &t) {
    e.bar_image = Proj.findElmImageID(t);
    e.bar_image_time.getUTC();
}
void PanelEditor::ParamsBorderImage(EditPanel &e, C Str &t) {
    e.border_image = Proj.findElmImageID(t);
    e.border_image_time.getUTC();
}
void PanelEditor::ParamsTopImage(EditPanel &e, C Str &t) {
    e.top_image = Proj.findElmImageID(t);
    e.top_image_time.getUTC();
}
void PanelEditor::ParamsBottomImage(EditPanel &e, C Str &t) {
    e.bottom_image = Proj.findElmImageID(t);
    e.bottom_image_time.getUTC();
}
void PanelEditor::ParamsLeftRightImage(EditPanel &e, C Str &t) {
    e.left_right_image = Proj.findElmImageID(t);
    e.left_right_image_time.getUTC();
}
void PanelEditor::ParamsTopCornerImage(EditPanel &e, C Str &t) {
    e.top_corner_image = Proj.findElmImageID(t);
    e.top_corner_image_time.getUTC();
}
void PanelEditor::ParamsBottomCornerImage(EditPanel &e, C Str &t) {
    e.bottom_corner_image = Proj.findElmImageID(t);
    e.bottom_corner_image_time.getUTC();
}
void PanelEditor::ParamsPanelImage(EditPanel &e, C Str &t) {
    e.panel_image = Proj.findElmID(t, ELM_PANEL_IMAGE);
    e.panel_image_time.getUTC();
}
void PanelEditor::SetCornerSize(PanelEditor &editor) {
    if (editor.game) {
        if (editor.game->border_image && editor.game->top_corner_image) {
            ...
            editor.edit.top_corner_size_time.getUTC();
            editor.setChanged();
            editor.toGui();
        }
        if (editor.game->border_image && editor.game->bottom_corner_image) {
            ...
            editor.edit.bottom_corner_size_time.getUTC();
            editor.setChanged();
            editor.toGui();
        }
    }
...
void PanelEditor::SetTopSize(PanelEditor &editor) {
    if (editor.game && editor.game->border_image && editor.game->top_image) {
        ...
        editor.edit.top_size_time.getUTC();
        editor.setChanged();
        editor.toGui();
    }
}
void PanelEditor::SetBottomSize(PanelEditor &editor) {
    if (editor.game && editor.game->border_image && editor.game->bottom_image) {
        ...
        editor.edit.bottom_size_time.getUTC();
        editor.setChanged();
        editor.toGui();
    }
}
void PanelEditor::SetSideSize(PanelEditor &editor) {
    if (editor.game && editor.game->border_image && editor.game->left_right_image) {
        ...
        editor.edit.left_right_size_time.getUTC();
        editor.setChanged();
        editor.toGui();
    }
}
...
void PanelEditor::create() {
    ...
    Rect r = super ::create("Panel Editor", Vec2(0.02f, -0.07f), 0.036f, 0.043f, PropElmNameWidth);
    ...
    T += show_lines.create(Rect_LU(locate.rect().ru() + Vec2(0.01f, 0), 0.22f, 0.05f), "Show Lines").focusable(false);
    show_lines.mode = BUTTON_TOGGLE;
    flt y = r.min.y - 0.01f, h = 0.045f;
    T += set_corner_size.create(Rect_LU(0.02f, y, 0.69f, 0.043f), "Set Corner Size to match Border Pixel Ratio").func(SetCornerSize, T);
    y -= h;
    T += set_top_size.create(Rect_LU(0.02f, y, 0.69f, 0.043f), "Set Top Size to match Border Pixel Ratio").func(SetTopSize, T);
    y -= h;
    T += set_bottom_size.create(Rect_LU(0.02f, y, 0.69f, 0.043f), "Set Bottom Size to match Border Pixel Ratio").func(SetBottomSize, T);
    y -= h;
    T += set_side_size.create(Rect_LU(0.02f, y, 0.69f, 0.043f), "Set Side Size to match Border Pixel Ratio").func(SetSideSize, T);
    y -= h;
    T += gui_panel.create();
    Vec2 padd = defaultInnerPaddingSize();
    rect(Rect_C(0, 0, Min(1.7f + padd.x, D.w() * 2), Min(-y + padd.y + 0.01f, D.h() * 2)));
}
void PanelEditor::toGame() {
    if (game)
        edit.copyTo(*game, Proj);
}
void PanelEditor::toGui() {
    super::toGui();
    toGame();
}
PanelEditor &PanelEditor::hide() {
    set(null);
    super::hide();
    return T;
}
Rect PanelEditor::sizeLimit() C {
...
PanelEditor &PanelEditor::rect(C Rect &rect) {
    super::rect(rect);
    flt x = set_top_size.rect().max.x;
    if (props.elms())
        MAX(x, props[0].button.rect().max.x);
...
void PanelEditor::activate(Elm *elm) {
    set(elm);
    if (T.elm)
        super::activate();
}
void PanelEditor::toggle(Elm *elm) {
    if (elm == T.elm)
        elm = null;
    set(elm);
}
...
void PanelEditor::erasing(C UID &elm_id) {
    if (elm && elm->id == elm_id)
        set(null);
}
