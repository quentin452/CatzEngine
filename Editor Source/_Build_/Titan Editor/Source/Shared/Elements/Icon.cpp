...
bool IconSettings::newer(C IconSettings &src) C {
    return mip_maps_time > src.mip_maps_time || auto_center_time > src.auto_center_time || light0_shadow_time > src.light0_shadow_time || light1_shadow_time > src.light1_shadow_time || type_time > src.type_time || width_time > src.width_time || height_time > src.height_time || scale_time > src.scale_time || fov_time > src.fov_time || cam_angle_time > src.cam_angle_time || cam_focus_time > src.cam_focus_time || ambient_col_time > src.ambient_col_time || ambient_occl_time > src.ambient_occl_time || ambient_range_time > src.ambient_range_time || bloom_original_time > src.bloom_original_time || bloom_scale_time > src.bloom_scale_time || bloom_cut_time > src.bloom_cut_time || bloom_glow_time > src.bloom_glow_time || light0_col_time > src.light0_col_time || light1_col_time > src.light1_col_time || light0_angle_time > src.light0_angle_time || light1_angle_time > src.light1_angle_time;
}
...
bool IconSettings::load(File &f) {
    ...
    switch (f.decUIntV()) {
    case 4: {
        f >> mip_maps >> auto_center >> light0_shadow >> light1_shadow >> type >> width >> height >> scale >> fov >> ambient_occl >> ambient_range >> cam_angle >> cam_focus >> ambient_col >> bloom_original >> bloom_scale >> bloom_cut >> bloom_glow >> light0_col >> light1_col >> light0_angle >> light1_angle >> mip_maps_time >> auto_center_time >> light0_shadow_time >> light1_shadow_time >> type_time >> width_time >> height_time >> scale_time >> fov_time >> cam_angle_time >> cam_focus_time >> ambient_col_time >> ambient_occl_time >> ambient_range_time >> bloom_original_time >> bloom_scale_time >> bloom_cut_time >> bloom_glow_time >> light0_col_time >> light1_col_time >> light0_angle_time >> light1_angle_time;
        if (f.ok())
            return true;
    } break;

    case 3: {
        f >> mip_maps >> auto_center >> light0_shadow >> light1_shadow >> type >> width >> height >> scale >> fov >> ambient_occl >> ambient_range >> cam_angle >> cam_focus >> ambient_col >> bloom_original >> bloom_scale >> bloom_cut >> light0_col >> light1_col >> light0_angle >> light1_angle >> mip_maps_time >> auto_center_time >> light0_shadow_time >> light1_shadow_time >> type_time >> width_time >> height_time >> scale_time >> fov_time >> cam_angle_time >> cam_focus_time >> ambient_col_time >> ambient_occl_time >> ambient_range_time >> bloom_original_time >> bloom_scale_time >> bloom_cut_time >> light0_col_time >> light1_col_time >> light0_angle_time >> light1_angle_time;
        bloom_scale *= 1.6f;
        if (f.ok())
            return true;
    } break;
    ...
    case 2: {
        f >> mip_maps >> auto_center >> light0_shadow >> light1_shadow >> type >> width >> height >> scale >> fov >> ambient_occl >> ambient_range >> cam_angle >> cam_focus >> ambient_col >> bloom_original >> bloom_scale >> bloom_cut >> bloom_contrast >> light0_col >> light1_col >> light0_angle >> light1_angle >> mip_maps_time >> auto_center_time >> light0_shadow_time >> light1_shadow_time >> type_time >> width_time >> height_time >> scale_time >> fov_time >> cam_angle_time >> cam_focus_time >> ambient_col_time >> ambient_occl_time >> ambient_range_time >> bloom_original_time >> bloom_scale_time >> bloom_cut_time >> bloom_contrast_time >> light0_col_time >> light1_col_time >> light0_angle_time >> light1_angle_time;
        bloom_scale *= 1.6f;
        if (type >= 1)
    ...
    case 1: {
        f >> mip_maps >> auto_center >> light0_shadow >> type >> width >> height >> scale >> fov >> ambient_occl >> ambient_range >> cam_angle >> cam_focus >> ambient_col >> bloom_original >> bloom_scale >> bloom_cut >> bloom_contrast >> light0_col >> light1_col >> light0_angle >> light1_angle >> mip_maps_time >> auto_center_time >> light0_shadow_time >> type_time >> width_time >> height_time >> scale_time >> fov_time >> cam_angle_time >> cam_focus_time >> ambient_col_time >> ambient_occl_time >> ambient_range_time >> bloom_original_time >> bloom_scale_time >> bloom_cut_time >> bloom_contrast_time >> light0_col_time >> light1_col_time >> light0_angle_time >> light1_angle_time;
        light1_shadow = light0_shadow;
        light1_shadow_time = light0_shadow_time;
        bloom_scale *= 1.6f;
        if (type >= 1)
            type = ElmImage::TYPE(type + 1);
        if (f.ok())
    ...
    case 0:
        reset();
        return f.ok(); // 0 -> as default values
    }
    reset();
    return false;
}
