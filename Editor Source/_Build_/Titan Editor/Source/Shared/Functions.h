...
template <typename TYPE>
bool Undo(TimeStamp &time, C TimeStamp &src_time, TYPE &data, C TYPE &src_data);
template <typename TYPE>
bool UndoEqual(TimeStamp &time, C TimeStamp &src_time, TYPE &data, C TYPE &src_data);
template <typename TYPE>
bool UndoMem(TimeStamp &time, C TimeStamp &src_time, TYPE &data, C TYPE &src_data);
...
inline flt SRGBToBrightness(flt x);
inline flt BrightnessToSRGB(flt x);
flt _ApplyBrightness(flt x, flt brightness);
inline flt SRGBToContrast(flt x);
inline flt ContrastToSRGB(flt x);
flt _ApplyContrast(flt x, flt contrast);
