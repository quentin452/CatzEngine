...
struct FileText {
    ...
    FileText &fullLine(Str &s);
    Str fullLine() {
        Str s;
        fullLine(s);
        return s;
    } // read text until end of line found, includes starting white chars (spaces and tabs)
    FileText &getLine(Str &s);
    Str getLine() {
        Str s;
        getLine(s);
        return s;
    }                           // read text until end of line found, skips    starting white chars (spaces and tabs)
    FileText &getLine(Str8 &s); // read text until end of line found, skips    starting white chars (spaces and tabs)
    FileText &getAll(Str &s);
    Str getAll() {
        Str s;
        getAll(s);
        return s;
