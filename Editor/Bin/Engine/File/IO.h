...
T1(TYPE)
void FList(C Str &path, FILE_LIST_MODE func(C FileFind &ff, TYPE *user), TYPE *user = null); // list all elements inside specified path (in recursive mode) and report them into custom 'func' callback function, 'user'=custom user data
T1(TYPE)
void FList(C Str &path, FILE_LIST_MODE func(C FileFind &ff, TYPE &user), TYPE &user); // list all elements inside specified path (in recursive mode) and report them into custom 'func' callback function, 'user'=custom user data
