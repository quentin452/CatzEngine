...
struct GuiObjs // Set of Gui Objects
{
    ...
    T1(TYPE)
    GuiObjs &replaceButton() {
        _button.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceCheckBox() {
        _checkbox.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceComboBox() {
        _combobox.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceCustom() {
        _custom.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceDesktop() {
        _desktop.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceImage() {
        _image.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceList() {
        _list.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceMenu() {
        _menu.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceMenuBar() {
        _menubar.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceProgress() {
        _progress.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceRegion() {
        _region.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceSlideBar() {
        _slidebar.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceSlider() {
        _slider.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceTabs() {
        _tabs.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceText() {
        _text.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceTextBox() {
        _textbox.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceTextLine() {
        _textline.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceViewport() {
        _viewport.replaceClass<TYPE>();
        return T;
    }
    T1(TYPE)
    GuiObjs &replaceWindow() {
        _window.replaceClass<TYPE>();
        return T;
    }
    ...
    // manage
    T1(TYPE)
    struct ObjName : TYPE // Gui Object with its name
    {
        Str name;
    };
