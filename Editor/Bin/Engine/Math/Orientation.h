...
struct OrientD // Orientation (double precision)
{
    ...
    OrientD() {}
    OrientD(C VecD &dir, C VecD &perp) {
        T.dir = dir;
        T.perp = perp;
    }
...
struct OrientP : Orient // Positioned Orientation
{
    ...
    OrientP() {}
    OrientP(C Vec &pos, C Vec &dir, C Vec &perp) {
        T.pos = pos;
        T.dir = dir;
        T.perp = perp;
    }
...
struct OrientM : Orient // Positioned Orientation (mixed precision)
{
    ...
    OrientM() {}
    OrientM(C VecD &pos, C Vec &dir, C Vec &perp) {
        T.pos = pos;
        T.dir = dir;
        T.perp = perp;
    }
...
struct OrientPD : OrientD // Positioned Orientation (double precision)
{
    ...
    OrientPD() {}
    OrientPD(C VecD &pos, C VecD &dir, C VecD &perp) {
        T.pos = pos;
        T.dir = dir;
        T.perp = perp;
    }
