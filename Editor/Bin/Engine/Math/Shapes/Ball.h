...
struct Ball // Ball Shape
{
    ...
    Ball &set(Flt r, C Vec &pos = VecZero) {
        T.r = r;
        T.pos = pos;
        return T;
    }
...
struct SphereArea : VecI2 {
    ...
    SphereArea &set(DIR_ENUM side, Int x, Int y) {
        T.side = side;
        T.x = x;
        T.y = y;
        return T;
...
struct SphereAreaUS : VecUS2 {
    ...
    SphereAreaUS &set(DIR_ENUM side, UShort x, UShort y) {
        T.side = side;
        T.x = x;
        T.y = y;
        return T;
