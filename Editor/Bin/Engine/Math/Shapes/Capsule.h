...
struct Capsule // Capsule Shape
{
    ...
    // set
    Capsule &set(Flt r, Flt h, C Vec &pos = VecZero, C Vec &up = Vec(0, 1, 0)) {
        T.r = r;
        T.h = h;
        T.pos = pos;
        T.up = up;
...
struct CapsuleM // Capsule Shape (mixed precision)
{
    ...
    // set
    CapsuleM &set(Flt r, Flt h, C VecD &pos = VecDZero, C Vec &up = Vec(0, 1, 0)) {
        T.r = r;
        T.h = h;
        T.pos = pos;
        T.up = up;
