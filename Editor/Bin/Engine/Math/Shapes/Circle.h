...
struct Circle // Circle Shape
{
    ...
    // set
    Circle &set(Flt r, C Vec2 &pos = Vec2Zero) {
        T.r = r;
        T.pos = pos;
        return T;
    }
    Circle &set(Flt r, Flt x, Flt y) {
        T.r = r;
        T.pos.set(x, y);
        return T;
    }
...
struct CircleM // Circle Shape (mixed precision)
{
    ...
    // set
    CircleM &set(Flt r, C VecD2 &pos = VecD2Zero) {
        T.r = r;
        T.pos = pos;
        return T;
    }
    CircleM &set(Flt r, Dbl x, Dbl y) {
        T.r = r;
        T.pos.set(x, y);
        return T;
    }
...
struct CircleD // Circle Shape (double precision)
{
    ...
    // set
    CircleD &set(Dbl r, C VecD2 &pos = VecD2Zero) {
        T.r = r;
        T.pos = pos;
        return T;
    }
    CircleD &set(Dbl r, Dbl x, Dbl y) {
        T.r = r;
        T.pos.set(x, y);
        return T;
    }
