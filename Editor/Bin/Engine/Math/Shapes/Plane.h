...
struct Plane2 // Plane 2D
{
    ...
    Plane2 &set(C Vec2 &pos, C Vec2 &normal) {
        T.pos = pos;
        T.normal = normal;
        return T;
    }
...
struct PlaneD2 // Plane 2D (double precision)
{
    ...
    PlaneD2 &set(C VecD2 &pos, C VecD2 &normal) {
        T.pos = pos;
        T.normal = normal;
        return T;
    }
...
struct Plane // Plane 3D
{
    ...
    Plane &set(C Vec &pos, C Vec &normal) {
        T.pos = pos;
        T.normal = normal;
        return T;
    }

    Plane &operator+=(C Vec &d) {
        T.pos += d;
        return T;
    }
    Plane &operator-=(C Vec &d) {
...
struct PlaneM // Plane 3D (mixed precision)
{
    ...
    PlaneM &set(C VecD &pos, C Vec &normal) {
        T.pos = pos;
        T.normal = normal;
        return T;
    }
...
struct PlaneD // Plane 3D (double precision)
{
    ...
    PlaneD &set(C VecD &pos, C VecD &normal) {
        T.pos = pos;
        T.normal = normal;
        return T;
    }
