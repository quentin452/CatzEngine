...
/******************************************************************************/
T1(TYPE)
struct Meml : _Meml // List Based Container
{
    // manage
    ...
    template <Int size>
    Meml &operator=(C Memt<TYPE, size> &src); // copy elements using assignment operator
    ...
    template <Int size>
    Meml &operator=(C CMemPtr<TYPE, size> &src); // copy elements using assignment operator
