...
/******************************************************************************/
template <const_mem_addr typename TYPE, Int size>
struct Memt // Temporary Memory Based Container, 'TYPE'=type of elements to be stored in this container, 'size'=memory size (in bytes) that can be used for storing the elements without having to allocate any dynamic memory
{
    ...
    T1(VALUE)
    Memt &binaryAdd(C VALUE &value, Int compare(C TYPE &a, C VALUE &b) = Compare) {
        Int i;
    ...
    Memt &operator=(C Memt<TYPE, src_size> &src); // copy elements using assignment operator (this will allow copying from 'Memt' with other sizes)
    ...
    template <Int src_size>
    Memt &operator=(C CMemPtr<TYPE, src_size> &src); // copy elements using assignment operator
...
struct MemtN : Memt<TYPE, SIZE(TYPE) * Memt_elms> // Temporary Memory Based Container, 'TYPE'=type of elements to be stored in this container, 'Memt_elms'=number of elements that can be stored without having to allocate any dynamic memory
{
    ...
    template <Int src_size>
    MemtN &operator=(C Memt<TYPE, src_size> &src);   // copy elements using assignment operator (this will allow copying from 'Memt' with other sizes)
    ...
    template <Int src_size>
    MemtN &operator=(C CMemPtr<TYPE, src_size> &src); // copy elements using assignment operator
};
/******************************************************************************/
template <typename TYPE, Int size>
inline Int Elms(C Memt<TYPE, size> &memt) { return memt.elms(); }
/******************************************************************************/
#if EE_PRIVATE
