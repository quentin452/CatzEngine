...
struct Param // Parameter
{
    ...
    T1(TYPE)
    TYPE asEnum(TYPE invalid_value) C {
        Int e = asEnum();
        return (e < 0) ? invalid_value : TYPE(e);
    } // use this method for custom enum types, 'invalid_value'=enum value to use when desired value was not found
