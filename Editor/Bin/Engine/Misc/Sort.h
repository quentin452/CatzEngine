...
inline Int Compare(C SByte &a, C SByte &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C Byte &a, C Byte &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C Short &a, C Short &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C UShort &a, C UShort &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C Int &a, C Int &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C UInt &a, C UInt &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C Long &a, C Long &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C ULong &a, C ULong &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C Flt &a, C Flt &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C Dbl &a, C Dbl &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C Ptr &a, C Ptr &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
inline Int Compare(C CPtr &a, C CPtr &b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
Compare(C TYPE &a, C TYPE &b) {
    ...
    if (a > b)
        return +1;
    return 0;
} // compare 'a' 'b' enum values and return -1, 0, +1

inline Int ComparePtr(CPtr a, CPtr b) {
    if (a < b)
        return -1;
    if (a > b)
        return +1;
...
T1(TYPE)
void Sort(TYPE *data, Int elms, Int compare(C TYPE &a, C TYPE &b) = Compare); // sort custom array using custom comparing function
...
T2(DATA, VALUE)
Bool BinarySearch(C DATA *data, Int elms, C VALUE &value, Int &index, Int compare(C DATA &a, C VALUE &b) = Compare);
T2(DATA, VALUE)
Bool BinarySearchFirst(C DATA *data, Int elms, C VALUE &value, Int &index, Int compare(C DATA &a, C VALUE &b) = Compare); // if there are multiple elements with same value, then the first one will be returned
T2(DATA, VALUE)
Bool BinaryHas(C DATA *data, Int elms, C VALUE &value, Int compare(C DATA &a, C VALUE &b) = Compare) {
    Int i;
    return BinarySearch(data, elms, value, i, compare);
} // check if 'value' is present in array
T2(DATA, VALUE)
DATA *BinaryFind(DATA *data, Int elms, C VALUE &value, Int compare(C DATA &a, C VALUE &b) = Compare) {
    Int i;
    return BinarySearch(data, elms, value, i, compare) ? &data[i] : null;
} // check if 'value' is present in array and return it, null on fail
/******************************************************************************/
