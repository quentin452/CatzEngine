...
template <Int elms>
Int SetReturnLength(Char (&dest)[elms], CChar *src) { return SetReturnLength(dest, src, elms); } // set text, return written length (autodetect dest_elms)
template <Int elms>
Int SetReturnLength(Char8 (&dest)[elms], CChar8 *src) { return SetReturnLength(dest, src, elms); } // set text, return written length (autodetect dest_elms)

template <Int elms>
void MergePath(Char (&dest)[elms], CChar *first, CChar *second) { return MergePath(dest, first, second, elms); } // merge paths (autodetect dest_elms)
template <Int elms>
void MergePath(Char8 (&dest)[elms], CChar8 *first, CChar8 *second) { return MergePath(dest, first, second, elms); } // merge paths (autodetect dest_elms)
#endif

template <Int elms>
Char *Set(Char (&dest)[elms], CChar *src) { return Set(dest, src, elms); } // set    'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
template <Int elms>
Char *Set(Char (&dest)[elms], CChar8 *src) { return Set(dest, src, elms); } // set    'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
template <Int elms>
Char8 *Set(Char8 (&dest)[elms], CChar *src) { return Set(dest, src, elms); } // set    'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
template <Int elms>
Char8 *Set(Char8 (&dest)[elms], CChar8 *src) { return Set(dest, src, elms); } // set    'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
template <Int elms>
Char *Append(Char (&dest)[elms], CChar *src) { return Append(dest, src, elms); } // append 'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
template <Int elms>
Char *Append(Char (&dest)[elms], CChar8 *src) { return Append(dest, src, elms); } // append 'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
template <Int elms>
Char8 *Append(Char8 (&dest)[elms], CChar *src) { return Append(dest, src, elms); } // append 'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
template <Int elms>
Char8 *Append(Char8 (&dest)[elms], CChar8 *src) { return Append(dest, src, elms); } // append 'dest' text from 'src' and return 'dest' (autodetect 'dest_elms')
...
Bool TextBool(CChar *t);
Bool TextBool(CChar8 *t); // false     on fail (if 't' string is empty, then 'false' is returned)
Bool TextBool1(CChar *t);
Bool TextBool1(CChar8 *t); // false     on fail (if 't' string is empty, then 'true'  is returned)
Int TextInt(CChar *t);
Int TextInt(CChar8 *t); // 0         on fail
UInt TextUInt(CChar *t);
UInt TextUInt(CChar8 *t); // 0         on fail
Long TextLong(CChar *t);
Long TextLong(CChar8 *t); // 0         on fail
ULong TextULong(CChar *t);
ULong TextULong(CChar8 *t); // 0         on fail
Flt TextFlt(CChar *t);
Flt TextFlt(CChar8 *t); // 0         on fail
Dbl TextDbl(CChar *t);
Dbl TextDbl(CChar8 *t); // 0         on fail
Vec2 TextVec2(CChar *t);
Vec2 TextVec2(CChar8 *t); // (0,0)     on fail
VecD2 TextVecD2(CChar *t);
VecD2 TextVecD2(CChar8 *t); // (0,0)     on fail
VecI2 TextVecI2(CChar *t);
VecI2 TextVecI2(CChar8 *t); // (0,0)     on fail
VecB2 TextVecB2(CChar *t);
VecB2 TextVecB2(CChar8 *t); // (0,0)     on fail
VecSB2 TextVecSB2(CChar *t);
VecSB2 TextVecSB2(CChar8 *t); // (0,0)     on fail
VecUS2 TextVecUS2(CChar *t);
VecUS2 TextVecUS2(CChar8 *t); // (0,0)     on fail
Vec TextVec(CChar *t);
Vec TextVec(CChar8 *t); // (0,0,0)   on fail
VecD TextVecD(CChar *t);
VecD TextVecD(CChar8 *t); // (0,0,0)   on fail
VecI TextVecI(CChar *t);
VecI TextVecI(CChar8 *t); // (0,0,0)   on fail
VecB TextVecB(CChar *t);
VecB TextVecB(CChar8 *t); // (0,0,0)   on fail
VecSB TextVecSB(CChar *t);
VecSB TextVecSB(CChar8 *t); // (0,0,0)   on fail
VecUS TextVecUS(CChar *t);
VecUS TextVecUS(CChar8 *t); // (0,0,0)   on fail
Vec4 TextVec4(CChar *t);
Vec4 TextVec4(CChar8 *t); // (0,0,0,0) on fail
VecD4 TextVecD4(CChar *t);
VecD4 TextVecD4(CChar8 *t); // (0,0,0,0) on fail
VecI4 TextVecI4(CChar *t);
VecI4 TextVecI4(CChar8 *t); // (0,0,0,0) on fail
VecB4 TextVecB4(CChar *t);
VecB4 TextVecB4(CChar8 *t); // (0,0,0,0) on fail
VecSB4 TextVecSB4(CChar *t);
VecSB4 TextVecSB4(CChar8 *t); // (0,0,0,0) on fail
VecUS4 TextVecUS4(CChar *t);
VecUS4 TextVecUS4(CChar8 *t); // (0,0,0,0) on fail
Color TextColor(CChar *t);
Color TextColor(CChar8 *t); // (0,0,0,0) on fail
UID TextUID(CChar *t);
UID TextUID(CChar8 *t); // 'UIDZero' on fail
VecI4 TextVer(CChar *t);
VecI4 TextVer(CChar8 *t); // (0,0,0,0) on fail
