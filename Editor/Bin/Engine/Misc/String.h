...
struct Str // Text String (16-bit per character)
{
...
#elif APPLE
    Str(NSString *s);
    Str &operator=(NSString *s);
    Str &operator+=(NSString *s);
    Str operator+(NSString *s) C;
    Str(CFStringRef s);
    Str &operator=(CFStringRef s);
    Str &operator+=(CFStringRef s);
    Str operator+(CFStringRef s) C;
#endif
    ...
    Str &operator=(Char c);
    Str &operator+=(Char c);
    Str operator+(Char c) C;
    Str(Char8 c);
    Str &operator=(Char8 c);
    Str &operator+=(Char8 c);
    Str operator+(Char8 c) C;
    Str(CChar *t);
    Str &operator=(CChar *t);
    Str &operator+=(CChar *t);
    Str operator+(CChar *t) C;
    Str(CChar8 *t);
    Str &operator=(CChar8 *t);
    Str &operator+=(CChar8 *t);
    Str operator+(CChar8 *t) C;
    Str(C wchar_t *t);
    Str &operator=(C wchar_t *t);
    Str &operator+=(C wchar_t *t);
    Str operator+(C wchar_t *t) C;
    Str(C Str &s);
    Str &operator=(C Str &s);
    Str &operator+=(C Str &s);
    Str operator+(C Str &s) C;
    Str(C Str8 &s);
    Str &operator=(C Str8 &s);
    Str &operator+=(C Str8 &s);
    Str operator+(C Str8 &s) C;
    Str(Bool b);
    Str &operator=(Bool b);
    Str &operator+=(Bool b);
    Str operator+(Bool b) C;
    Str(SByte i);
    Str &operator=(SByte i);
    Str &operator+=(SByte i);
    Str operator+(SByte i) C;
    Str(Int i);
    Str &operator=(Int i);
    Str &operator+=(Int i);
    Str operator+(Int i) C;
    Str(Long i);
    Str &operator=(Long i);
    Str &operator+=(Long i);
    Str operator+(Long i) C;
    Str(Byte u);
    Str &operator=(Byte u);
    Str &operator+=(Byte u);
    Str operator+(Byte u) C;
    Str(UInt u);
    Str &operator=(UInt u);
    Str &operator+=(UInt u);
    Str operator+(UInt u) C;
    Str(ULong u);
    Str &operator=(ULong u);
    Str &operator+=(ULong u);
    Str operator+(ULong u) C;
    Str(Flt f);
    Str &operator=(Flt f);
    Str &operator+=(Flt f);
    Str operator+(Flt f) C;
    Str(Dbl d);
    Str &operator=(Dbl d);
    Str &operator+=(Dbl d);
    Str operator+(Dbl d) C;
    Str(CPtr p);
    Str &operator=(CPtr p);
    Str &operator+=(CPtr p);
    Str operator+(CPtr p) C;
    Str(C Vec2 &v);
    Str &operator=(C Vec2 &v);
    Str &operator+=(C Vec2 &v);
    Str operator+(C Vec2 &v) C;
    Str(C VecD2 &v);
    Str &operator=(C VecD2 &v);
    Str &operator+=(C VecD2 &v);
    Str operator+(C VecD2 &v) C;
    Str(C VecI2 &v);
    Str &operator=(C VecI2 &v);
    Str &operator+=(C VecI2 &v);
    Str operator+(C VecI2 &v) C;
    Str(C VecB2 &v);
    Str &operator=(C VecB2 &v);
    Str &operator+=(C VecB2 &v);
    Str operator+(C VecB2 &v) C;
    Str(C VecSB2 &v);
    Str &operator=(C VecSB2 &v);
    Str &operator+=(C VecSB2 &v);
    Str operator+(C VecSB2 &v) C;
    Str(C VecUS2 &v);
    Str &operator=(C VecUS2 &v);
    Str &operator+=(C VecUS2 &v);
    Str operator+(C VecUS2 &v) C;
    Str(C Vec &v);
    Str &operator=(C Vec &v);
    Str &operator+=(C Vec &v);
    Str operator+(C Vec &v) C;
    Str(C VecD &v);
    Str &operator=(C VecD &v);
    Str &operator+=(C VecD &v);
    Str operator+(C VecD &v) C;
    Str(C VecI &v);
    Str &operator=(C VecI &v);
    Str &operator+=(C VecI &v);
    Str operator+(C VecI &v) C;
    Str(C VecB &v);
    Str &operator=(C VecB &v);
    Str &operator+=(C VecB &v);
    Str operator+(C VecB &v) C;
    Str(C VecSB &v);
    Str &operator=(C VecSB &v);
    Str &operator+=(C VecSB &v);
    Str operator+(C VecSB &v) C;
    Str(C VecUS &v);
    Str &operator=(C VecUS &v);
    Str &operator+=(C VecUS &v);
    Str operator+(C VecUS &v) C;
    Str(C Vec4 &v);
    Str &operator=(C Vec4 &v);
    Str &operator+=(C Vec4 &v);
    Str operator+(C Vec4 &v) C;
    Str(C VecD4 &v);
    Str &operator=(C VecD4 &v);
    Str &operator+=(C VecD4 &v);
    Str operator+(C VecD4 &v) C;
    Str(C VecI4 &v);
    Str &operator=(C VecI4 &v);
    Str &operator+=(C VecI4 &v);
    Str operator+(C VecI4 &v) C;
    Str(C VecB4 &v);
    Str &operator=(C VecB4 &v);
    Str &operator+=(C VecB4 &v);
    Str operator+(C VecB4 &v) C;
    Str(C VecSB4 &v);
    Str &operator=(C VecSB4 &v);
    Str &operator+=(C VecSB4 &v);
    Str operator+(C VecSB4 &v) C;
    Str(C VecUS4 &v);
    Str &operator=(C VecUS4 &v);
    Str &operator+=(C VecUS4 &v);
    Str operator+(C VecUS4 &v) C;
    Str(C BStr &s);
    Str &operator=(C BStr &s);
    Str &operator+=(C BStr &s);
    Str operator+(C BStr &s) C;

    T1(TYPE)
    Str(TYPE i, ENABLE_IF_ENUM(TYPE, Ptr) dummy = null) : Str(ENUM_TYPE(TYPE)(i)) {}
    T1(TYPE)
    ENABLE_IF_ENUM(TYPE, Str &) operator=(TYPE i) {
        T = ENUM_TYPE(TYPE)(i);
        return T;
    }
    T1(TYPE)
    ...
    T1(TYPE)
    ENABLE_IF_ENUM(TYPE, Str) operator+(TYPE i) C { return T + ENUM_TYPE(TYPE)(i); }
...
extern const Str S; // Constant Empty String
/******************************************************************************/
// STRING LIBRARY
/******************************************************************************/
struct StrLibrary // String Library, efficient solution for storing multiple strings in a file using least possible amount of bytes
{
    ...
    void getStr(File &f, Str &str) C;
    Str getStr(File &f) C {
        Str s;
        getStr(f, s);
        return s;
    } // get 'str' string from 'f' file
...
T1(TYPE)
ENABLE_IF_ENUM(TYPE, Str &&) operator+(Str &&a, TYPE b) { return RValue(a += ENUM_TYPE(TYPE)(b)); }
/******************************************************************************/
