...
struct Str8 // Text String (8-bit per character)
{
    ...
    Str8(Char c);
    Str8 &operator=(Char c);
    Str8 &operator+=(Char c);
    Str operator+(Char c) C;
    Str8(Char8 c);
    Str8 &operator=(Char8 c);
    Str8 &operator+=(Char8 c);
    Str8 operator+(Char8 c) C;
    Str8(CChar *t);
    Str8 &operator=(CChar *t);
    Str8 &operator+=(CChar *t);
    Str operator+(CChar *t) C;
    Str8(CChar8 *t);
    Str8 &operator=(CChar8 *t);
    Str8 &operator+=(CChar8 *t);
    Str8 operator+(CChar8 *t) C;
    Str8(C wchar_t *t);
    Str8 &operator=(C wchar_t *t);
    Str8 &operator+=(C wchar_t *t);
    Str operator+(C wchar_t *t) C;
    Str8(C Str &s);
    Str8 &operator=(C Str &s);
    Str8 &operator+=(C Str &s);
    Str operator+(C Str &s) C;
    Str8(C Str8 &s);
    Str8 &operator=(C Str8 &s);
    Str8 &operator+=(C Str8 &s);
    Str8 operator+(C Str8 &s) C;
    Str8(Bool b);
    Str8 &operator=(Bool b);
    Str8 &operator+=(Bool b);
    Str8 operator+(Bool b) C;
    Str8(SByte i);
    Str8 &operator=(SByte i);
    Str8 &operator+=(SByte i);
    Str8 operator+(SByte i) C;
    Str8(Int i);
    Str8 &operator=(Int i);
    Str8 &operator+=(Int i);
    Str8 operator+(Int i) C;
    Str8(Long i);
    Str8 &operator=(Long i);
    Str8 &operator+=(Long i);
    Str8 operator+(Long i) C;
    Str8(Byte u);
    Str8 &operator=(Byte u);
    Str8 &operator+=(Byte u);
    Str8 operator+(Byte u) C;
    Str8(UInt u);
    Str8 &operator=(UInt u);
    Str8 &operator+=(UInt u);
    Str8 operator+(UInt u) C;
    Str8(ULong u);
    Str8 &operator=(ULong u);
    Str8 &operator+=(ULong u);
    Str8 operator+(ULong u) C;
    Str8(Flt f);
    Str8 &operator=(Flt f);
    Str8 &operator+=(Flt f);
    Str8 operator+(Flt f) C;
    Str8(Dbl d);
    Str8 &operator=(Dbl d);
    Str8 &operator+=(Dbl d);
    Str8 operator+(Dbl d) C;
    Str8(CPtr p);
    Str8 &operator=(CPtr p);
    Str8 &operator+=(CPtr p);
    Str8 operator+(CPtr p) C;
    Str8(C Vec2 &v);
    Str8 &operator=(C Vec2 &v);
    Str8 &operator+=(C Vec2 &v);
    Str8 operator+(C Vec2 &v) C;
    Str8(C VecD2 &v);
    Str8 &operator=(C VecD2 &v);
    Str8 &operator+=(C VecD2 &v);
    Str8 operator+(C VecD2 &v) C;
    Str8(C VecI2 &v);
    Str8 &operator=(C VecI2 &v);
    Str8 &operator+=(C VecI2 &v);
    Str8 operator+(C VecI2 &v) C;
    Str8(C VecB2 &v);
    Str8 &operator=(C VecB2 &v);
    Str8 &operator+=(C VecB2 &v);
    Str8 operator+(C VecB2 &v) C;
    Str8(C VecSB2 &v);
    Str8 &operator=(C VecSB2 &v);
    Str8 &operator+=(C VecSB2 &v);
    Str8 operator+(C VecSB2 &v) C;
    Str8(C VecUS2 &v);
    Str8 &operator=(C VecUS2 &v);
    Str8 &operator+=(C VecUS2 &v);
    Str8 operator+(C VecUS2 &v) C;
    Str8(C Vec &v);
    Str8 &operator=(C Vec &v);
    Str8 &operator+=(C Vec &v);
    Str8 operator+(C Vec &v) C;
    Str8(C VecD &v);
    Str8 &operator=(C VecD &v);
    Str8 &operator+=(C VecD &v);
    Str8 operator+(C VecD &v) C;
    Str8(C VecI &v);
    Str8 &operator=(C VecI &v);
    Str8 &operator+=(C VecI &v);
    Str8 operator+(C VecI &v) C;
    Str8(C VecB &v);
    Str8 &operator=(C VecB &v);
    Str8 &operator+=(C VecB &v);
    Str8 operator+(C VecB &v) C;
    Str8(C VecSB &v);
    Str8 &operator=(C VecSB &v);
    Str8 &operator+=(C VecSB &v);
    Str8 operator+(C VecSB &v) C;
    Str8(C VecUS &v);
    Str8 &operator=(C VecUS &v);
    Str8 &operator+=(C VecUS &v);
    Str8 operator+(C VecUS &v) C;
    Str8(C Vec4 &v);
    Str8 &operator=(C Vec4 &v);
    Str8 &operator+=(C Vec4 &v);
    Str8 operator+(C Vec4 &v) C;
    Str8(C VecD4 &v);
    Str8 &operator=(C VecD4 &v);
    Str8 &operator+=(C VecD4 &v);
    Str8 operator+(C VecD4 &v) C;
    Str8(C VecI4 &v);
    Str8 &operator=(C VecI4 &v);
    Str8 &operator+=(C VecI4 &v);
    Str8 operator+(C VecI4 &v) C;
    Str8(C VecB4 &v);
    Str8 &operator=(C VecB4 &v);
    Str8 &operator+=(C VecB4 &v);
    Str8 operator+(C VecB4 &v) C;
    Str8(C VecSB4 &v);
    Str8 &operator=(C VecSB4 &v);
    Str8 &operator+=(C VecSB4 &v);
    Str8 operator+(C VecSB4 &v) C;
    Str8(C VecUS4 &v);
    Str8 &operator=(C VecUS4 &v);
    Str8 &operator+=(C VecUS4 &v);
    Str8 operator+(C VecUS4 &v) C;
    Str8(C BStr &s);
    Str8 &operator=(C BStr &s);
    Str8 &operator+=(C BStr &s);
...
extern const Str8 S8; // Constant Empty String
/******************************************************************************/
