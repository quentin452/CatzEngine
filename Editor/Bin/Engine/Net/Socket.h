...
struct SockAddr // Socket Address
{
    ...
    Int port() C;
    SockAddr &port(Int port); // get/set port
    UInt ip4() C;
    SockAddr &ip4(UInt ip4); // get/set IPv4
    Str8 ip4Text() C;
    Bool ip4Text(C Str8 &ip4); // get/set IPv4 in text format
    Str8 ip6Text() C;
    Bool ip6Text(C Str8 &ip6); // get/set IPv6 in text format
    Str8 ipText() C;
    Bool ipText(C Str8 &ip); // get/set IP   in text format
