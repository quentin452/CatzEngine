...
struct JClass : JObject {
    ...
    JClass(JClass &&temp) : JObject(temp._jni, temp._) {
        _global = temp._global;
        temp.clear();
    }
};
...
struct JString : JObject {
    ...
    JString(JString &&temp) : JObject(temp._jni, temp._) {
        _global = temp._global;
        temp.clear();
    }
};
...
struct JObjectArray : JObject {
    ...
    JObjectArray &operator=(jobject j) {
        JObject::operator=(j);
        return T;
    }
    ...
    JObjectArray(JObjectArray &&temp) : JObject(temp._jni, temp._) {
        _global = temp._global;
        temp.clear();
    }
};
