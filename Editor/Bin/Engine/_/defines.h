...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator-(TYPE a, TYPE b) {
    return Int(a) - Int(b);
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator+(Bool a, TYPE b) {
    return a + Int(b);
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator*(Bool a, TYPE b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator+(Int a, TYPE b) {
    return a + Int(b);
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator-(Int a, TYPE b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, UInt) operator+(UInt a, TYPE b) {
    return a + UInt(b);
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, UInt) operator-(UInt a, TYPE b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, ULong) operator+(ULong a, TYPE b) {
    return a + ULong(b);
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, ULong) operator-(ULong a, TYPE b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Flt) operator+(Flt a, TYPE b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Dbl) operator+(Dbl a, TYPE b) {
    return a + ENUM_TYPE(TYPE)(b);
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Dbl) operator-(Dbl a, TYPE b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator+(TYPE a, Bool b) {
    return Int(a) + b;
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator-(TYPE a, Bool b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator+(TYPE a, Int b) {
    return Int(a) + b;
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Int) operator-(TYPE a, Int b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, UInt) operator+(TYPE a, UInt b) {
    return UInt(a) + b;
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, UInt) operator-(TYPE a, UInt b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, ULong) operator+(TYPE a, ULong b) {
    return ULong(a) + b;
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, ULong) operator-(TYPE a, ULong b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Flt) operator+(TYPE a, Flt b) {
...
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Dbl) operator+(TYPE a, Dbl b) {
    return ENUM_TYPE(TYPE)(a) + b;
}
T1(TYPE)
constexpr ENABLE_IF_ENUM(TYPE, Dbl) operator-(TYPE a, Dbl b) {
...
T2(TA, TB)
TA &CTOR(TA &elm, TB &param) {
    new (&elm) TA(param);
    return elm;
} // constructor with a parameter
T2(TA, TB)
TA &CTOR(TA &elm, C TB &param) {
    new (&elm) TA(param);
    return elm;
} // constructor with a parameter

T1(TYPE)
Bool OK(TYPE x) { return x >= 0; }
T1(TYPE)
void RELEASE(TYPE *&x) {
    if (x) {
        x->Release();
