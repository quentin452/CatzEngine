...
struct DisplayClass : DisplayState, DisplayDraw // Display Control
{
 ...
 C Str8&           deviceName     ()C {return _device_name   ;} // get GPU device name
   ...
   DisplayClass& eyeAdaptationBrightness(  Flt  brightness  );   Flt  eyeAdaptationBrightness()C {return _eye_adapt_brightness;} // set/get Eye Adaptation brightness           (                   0..Inf                   , default= 0.06            ), total scale of lighting, the change is instant, you can call it real-time
   ...
   DisplayClass& eyeAdaptationWeight    (C Vec &weight      ); C Vec& eyeAdaptationWeight    ()C {return _eye_adapt_weight    ;} // set/get Eye Adaptation color weight         (           (0, 0, 0)..(1, 1, 1)             , default=(0.687, 1, 0.486)), the change is instant, you can call it real-time
