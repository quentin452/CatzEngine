...
static INLINE Flt SincSinc(Flt x) {
    ...
    x *= PI;
    Flt xx = Sqr(x);
    return xx ? Sin(x) * Sin(x * JINC_SMOOTH) / xx : JINC_SMOOTH;
}
...
static INLINE Flt JincJinc(Flt x) {
    ...
    x *= PI;
    Flt xx = Sqr(x);
    return xx ? J1(x) * J1(x * JINC_SMOOTH) / xx : 0.25f * JINC_SMOOTH;
}
...
PtrImagePixel GetImagePixelF(FILTER_TYPE filter) {
    switch (filter) {
    case FILTER_NONE:
        return &Image::pixelFNearest;
    case FILTER_LINEAR:
        return &Image::pixelFLinear;
    case FILTER_CUBIC_FAST:
        return &Image::pixelFCubicFast;
    case FILTER_CUBIC_FAST_SMOOTH:
        return &Image::pixelFCubicFastSmooth;
    case FILTER_CUBIC_FAST_MED:
        return &Image::pixelFCubicFastMed;
    case FILTER_CUBIC_FAST_SHARP:
        return &Image::pixelFCubicFastSharp;
    default: // FILTER_BEST, FILTER_WAIFU, FILTER_EASU
    case FILTER_CUBIC_PLUS:
        return &Image::pixelFCubicPlus;
    case FILTER_CUBIC_PLUS_SHARP:
        return &Image::pixelFCubicPlusSharp;
    }
}
PtrImagePixel3D GetImagePixel3DF(FILTER_TYPE filter) {
    switch (filter) {
    case FILTER_NONE:
        return &Image::pixel3DFNearest;
    case FILTER_LINEAR:
        return &Image::pixel3DFLinear;
    case FILTER_CUBIC_FAST:
        return &Image::pixel3DFCubicFast;
    case FILTER_CUBIC_FAST_SMOOTH:
        return &Image::pixel3DFCubicFastSmooth;
    case FILTER_CUBIC_FAST_MED:
        return &Image::pixel3DFCubicFastMed;
    case FILTER_CUBIC_FAST_SHARP:
        return &Image::pixel3DFCubicFastSharp;
    default: // FILTER_BEST, FILTER_WAIFU, FILTER_EASU
    case FILTER_CUBIC_PLUS:
        return &Image::pixel3DFCubicPlus;
    case FILTER_CUBIC_PLUS_SHARP:
        return &Image::pixel3DFCubicPlusSharp;
    }
}
PtrImageColor GetImageColorF(FILTER_TYPE filter) {
    switch (filter) {
    case FILTER_NONE:
        return &Image::colorFNearest;
    case FILTER_LINEAR:
        return &Image::colorFLinear;
    case FILTER_CUBIC_FAST:
        return &Image::colorFCubicFast;
    case FILTER_CUBIC_FAST_SMOOTH:
        return &Image::colorFCubicFastSmooth;
    case FILTER_CUBIC_FAST_MED:
        return &Image::colorFCubicFastMed;
    case FILTER_CUBIC_FAST_SHARP:
        return &Image::colorFCubicFastSharp;
    default: // FILTER_BEST, FILTER_WAIFU, FILTER_EASU
    case FILTER_CUBIC_PLUS:
        return &Image::colorFCubicPlus;
    case FILTER_CUBIC_PLUS_SHARP:
        return &Image::colorFCubicPlusSharp;
    }
}
PtrImageColor3D GetImageColor3DF(FILTER_TYPE filter) {
    switch (filter) {
    case FILTER_NONE:
        return &Image::color3DFNearest;
    case FILTER_LINEAR:
        return &Image::color3DFLinear;
    case FILTER_CUBIC_FAST:
        return &Image::color3DFCubicFast;
    case FILTER_CUBIC_FAST_SMOOTH:
        return &Image::color3DFCubicFastSmooth;
    case FILTER_CUBIC_FAST_MED:
        return &Image::color3DFCubicFastMed;
    case FILTER_CUBIC_FAST_SHARP:
        return &Image::color3DFCubicFastSharp;
    default: // FILTER_BEST, FILTER_WAIFU, FILTER_EASU
    case FILTER_CUBIC_PLUS:
        return &Image::color3DFCubicPlus;
    case FILTER_CUBIC_PLUS_SHARP:
        return &Image::color3DFCubicPlusSharp;
    }
}
PtrImageAreaColor GetImageAreaColor(FILTER_TYPE filter, Bool &linear_gamma) {
    ...
    case FILTER_LINEAR:
        linear_gamma = true;
        return &Image::areaColorLLinear;
    case FILTER_CUBIC_FAST:
        linear_gamma = true;
        return &Image::areaColorLCubicFast;
    case FILTER_CUBIC_FAST_SMOOTH:
        linear_gamma = true;
        return &Image::areaColorLCubicFastSmooth;
    default:
        ASSERT(FILTER_DOWN == FILTER_CUBIC_FAST_MED); // FILTER_BEST, FILTER_WAIFU, FILTER_EASU
    case FILTER_CUBIC_FAST_MED:
        linear_gamma = false;
        return &Image::areaColorFCubicFastMed; // FILTER_CUBIC_FAST_MED   is not suitable for linear gamma
    case FILTER_CUBIC_FAST_SHARP:
        linear_gamma = false;
        return &Image::areaColorFCubicFastSharp; // FILTER_CUBIC_FAST_SHARP is not suitable for linear gamma
    case FILTER_CUBIC_PLUS:
        linear_gamma = false;
        return &Image::areaColorFCubicPlus; // FILTER_CUBIC_PLUS       is not suitable for linear gamma
    case FILTER_CUBIC_PLUS_SHARP:
        linear_gamma = false;
        return &Image::areaColorFCubicPlusSharp; // FILTER_CUBIC_PLUS_SHARP is not suitable for linear gamma
    }
}
/******************************************************************************/
// PIXEL / COLOR
...
static inline void SetPixel(Byte *data, Int byte_pp, UInt pixel) {
    ...
    case 1:
        ...
        break;
    case 2:
        (*(U16 *)data) = pixel & 0xFFFF;
        break;
    case 3:
        (*(U16 *)data) = pixel & 0xFFFF;
        data[2] = (pixel >> 16) & 0xFF;
        break;
    case 4:
        (*(U32 *)data) = pixel;
        break;
...
static void SetR11G11B10F(Ptr data, C Vec &rgb) {
    ...
    *(UInt *)data = (h.x.data & 0x8000 ? 0 : ((h.x.data & 0x7FF0) >> 4)) | (h.y.data & 0x8000 ? 0 : ((h.y.data & 0x7FF0) << (11 - 4))) | (h.z.data & 0x8000 ? 0 : ((h.z.data & 0x7FE0) << (22 - 5)));
}
/******************************************************************************/
static void SetPixelF(Byte *data, IMAGE_TYPE type, Flt pixel) {
    ...
    case IMAGE_F16_2: {
        U16 *d = (U16 *)data;
        d[0] = d[1] = Half(pixel).data;
    } break;
    case IMAGE_F16_3: {
        U16 *d = (U16 *)data;
        d[0] = d[1] = d[2] = Half(pixel).data;
    } break;
    case IMAGE_F16_4: {
        U16 *d = (U16 *)data;
        d[0] = d[1] = d[2] = d[3] = Half(pixel).data;
    } break;
    ...
    case IMAGE_R8G8_SIGN: {
        VecSB2 &v = *(VecSB2 *)data;
        v.x = v.y = SFltToSByte(pixel);
    } break;
    case IMAGE_R8G8B8A8_SIGN: {
        VecSB4 &v = *(VecSB4 *)data;
        v.x = v.y = v.z = SFltToSByte(pixel);
        v.w = 127;
    } break;

    case IMAGE_R10G10B10A2: {
        UInt v = FltToU10(pixel);
        (*(UInt *)data) = v | (v << 10) | (v << 20) | (3 << 30);
    } break;
    ...
    case IMAGE_L8_SRGB:
    case IMAGE_I8:
        (*(U8 *)data) = FltToByte(pixel);
        break; // it's okay   to clamp int for small  values
    case IMAGE_I16:
        (*(U16 *)data) = RoundU(Sat(pixel) * 0x0000FFFFu);
        break; // it's better to clamp flt for bigger values
    case IMAGE_I32:
        (*(U32 *)data) = RoundUClamp(Sat(pixel) * 0xFFFFFFFFu);
        break; // it's better to clamp flt for bigger values
    case IMAGE_I24: {
        U32 c = RoundU(Sat(pixel) * 0x00FFFFFFu);
        (*(U16 *)data) = c;
        data[2] = (c >> 16);
    } break; // it's better to clamp flt for bigger values

    case IMAGE_R11G11B10F:
        SetR11G11B10F(data, pixel);
        break;
    }
}
...
static void SetPixelL(Byte *data, IMAGE_TYPE type, Flt pixel) {
    ...
    case IMAGE_F32_3_SRGB:
        (*(Vec *)data) = LinearToSRGB(pixel);
        break;
    case IMAGE_F32_4_SRGB:
        (*(Vec4 *)data) = LinearToSRGB(pixel);
        break;
    ...
    case IMAGE_R8G8B8A8_SRGB: {
        VecB4 &v = *(VecB4 *)data;
        v.x = v.y = v.z = LinearToByteSRGB(pixel);
        v.w = 255;
    } break;
    ...
    case IMAGE_L8_SRGB:
        (*(U8 *)data) = LinearToByteSRGB(pixel);
        break;
...
static Color DecompressPixel(C Image &image, Int x, Int y) {
    ...
    case IMAGE_BC1:
    case IMAGE_BC1_SRGB:
        return DecompressPixelBC1(data + (x >> 2) * 8, x3, y3);
    case IMAGE_BC2:
    case IMAGE_BC2_SRGB:
        return DecompressPixelBC2(data + (x >> 2) * 16, x3, y3);
    case IMAGE_BC3:
    case IMAGE_BC3_SRGB:
        return DecompressPixelBC3(data + (x >> 2) * 16, x3, y3);
    case IMAGE_BC4:
        return DecompressPixelBC4(data + (x >> 2) * 8, x3, y3);
    case IMAGE_BC5:
        return DecompressPixelBC5(data + (x >> 2) * 16, x3, y3);
    case IMAGE_BC7:
    case IMAGE_BC7_SRGB:
        return DecompressPixelBC7(data + (x >> 2) * 16, x3, y3);
    case IMAGE_ETC1:
        return DecompressPixelETC1(data + (x >> 2) * 8, x3, y3);
    case IMAGE_ETC2_R:
        return DecompressPixelETC2R(data + (x >> 2) * 8, x3, y3);
    case IMAGE_ETC2_RG:
        return DecompressPixelETC2RG(data + (x >> 2) * 16, x3, y3);
    case IMAGE_ETC2_RGB:
    case IMAGE_ETC2_RGB_SRGB:
        return DecompressPixelETC2RGB(data + (x >> 2) * 8, x3, y3);
    case IMAGE_ETC2_RGBA1:
    case IMAGE_ETC2_RGBA1_SRGB:
        return DecompressPixelETC2RGBA1(data + (x >> 2) * 8, x3, y3);
    case IMAGE_ETC2_RGBA:
    case IMAGE_ETC2_RGBA_SRGB:
        return DecompressPixelETC2RGBA(data + (x >> 2) * 16, x3, y3);
    }
    return TRANSPARENT;
}
...
Flt ImagePixelF(CPtr data, IMAGE_TYPE hw_type) {
    ...
    case IMAGE_D16:
        if (GL)
            return (*(U16 *)data) / Flt(0x0000FFFFu) * 2 - 1; // !! else fall through no break on purpose !!
    case IMAGE_I16:
    ...
    case IMAGE_D32:
    case IMAGE_D32S8X24:
        return GL ? (*(Flt *)data) * 2 - 1 : *(Flt *)data;
    ...
    case IMAGE_D24X8:
        if (GL)
            return (*(U16 *)(((Byte *)data) + 1) | (((Byte *)data)[3] << 16)) / Flt(0x00FFFFFFu) * 2 - 1; // !! else fall through no break on purpose !!
#endif
    case IMAGE_I24:
        return (*(U16 *)data | (((Byte *)data)[2] << 16)) / Flt(0x00FFFFFFu); // here Dbl is not required, this was tested

    case IMAGE_R10G10B10A2:
        return U10ToFlt((*(UInt *)data) & 0x3FF);

    case IMAGE_R11G11B10F:
        return GetR11G11B10F(data).x;
    ...
    case IMAGE_B4G4R4A4:
        return (((*(U16 *)data) >> 8) & 0x0F) / 15.0f;
    case IMAGE_B5G5R5A1:
        return (((*(U16 *)data) >> 10) & 0x1F) / 31.0f;
    case IMAGE_B5G6R5:
        return (((*(U16 *)data) >> 11) & 0x1F) / 31.0f;
    }
    return 0;
}
static inline Flt GetPixelF(C Byte *data, C Image &image, Bool _2d, Int x, Int y, Int z = 0) {
    ...
    case IMAGE_D24X8:
        if (GL)
            return (*(U16 *)(data + 1) | (data[3] << 16)) / Flt(0x00FFFFFFu) * 2 - 1; // !! else fall through no break on purpose !!
    case IMAGE_I24:
    ...
    case IMAGE_BC6:
        return DecompressPixelBC6(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3).x;

    case IMAGE_BC4_SIGN:
        return SByteToSFlt(DecompressPixelBC4S(image.data() + (x >> 2) * 8 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3));
    case IMAGE_BC5_SIGN:
        return SByteToSFlt(DecompressPixelBC4S(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3)); // can use 'DecompressPixelBC4S' because BC5 is made of 2xBC4

    case IMAGE_ETC2_R_SIGN:
        return SByteToSFlt(DecompressPixelETC2RS(image.data() + (x >> 2) * 8 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3));
    case IMAGE_ETC2_RG_SIGN:
        return SByteToSFlt(DecompressPixelETC2RS(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3)); // can use 'DecompressPixelETC2RS' because ETC2_RG is made of 2xETC2_R
...
static inline Color GetColor(C Byte *data, C Image &image, Bool _2d, Int x, Int y, Int z = 0) {
    ...
    case IMAGE_B8G8R8A8:
    case IMAGE_B8G8R8A8_SRGB: {
        C Color &c = *(Color *)data;
        return Color(c.b, c.g, c.r, c.a);
    }
    case IMAGE_R8G8B8A8:
    case IMAGE_R8G8B8A8_SRGB:
        return *(Color *)data;
    ...
    case IMAGE_R8G8: {
        C VecB2 &v = *(VecB2 *)data;
        return Color(v.x, v.y, 0, 255);
    }
    case IMAGE_R8:
        return Color(*data, 0, 0, 255);
    case IMAGE_A8:
        return Color(0, 0, 0, *data);
    case IMAGE_L8:
    case IMAGE_L8_SRGB: {
        Byte b = *data;
    ...
    case IMAGE_B8G8R8_SRGB: {
        C VecB &v = *(VecB *)data;
        return Color(v.z, v.y, v.x, 255);
    }

    case IMAGE_B4G4R4A4: {
        U16 d = *(U16 *)data;
        return Color(U4ToByte((d >> 8) & 0x0F), U4ToByte((d >> 4) & 0x0F), U4ToByte((d)&0x0F), U4ToByte(d >> 12));
    }
    case IMAGE_B5G5R5A1: {
        U16 d = *(U16 *)data;
        return Color(U5ToByte((d >> 10) & 0x1F), U5ToByte((d >> 5) & 0x1F), U5ToByte((d)&0x1F), U1ToByte(d >> 15));
    }
    case IMAGE_B5G6R5: {
        U16 d = *(U16 *)data;
        return Color(U5ToByte((d >> 11) & 0x1F), U6ToByte((d >> 5) & 0x3F), U5ToByte((d)&0x1F), 255);
    }
    case IMAGE_R10G10B10A2: {
        UInt d = *(UInt *)data;
        return Color((d >> 2) & 0xFF, (d >> 12) & 0xFF, (d >> 22) & 0xFF, U2ToByte(d >> 30));
    }

    case IMAGE_R8_SIGN: {
        SByte b = *(SByte *)data;
        return Color(SByteToByte(b), 0, 0, 255);
    }
    case IMAGE_R8G8_SIGN: {
        C VecSB2 &v = *(VecSB2 *)data;
        return Color(SByteToByte(v.x), SByteToByte(v.y), 0, 255);
    }
    case IMAGE_R8G8B8A8_SIGN: {
        C VecSB4 &v = *(VecSB4 *)data;
        return Color(SByteToByte(v.x), SByteToByte(v.y), SByteToByte(v.z), SByteToByte(v.w));
    }

    case IMAGE_F32: {
        C Flt &v = *(Flt *)data;
        return Color(FltToByte(v), 0, 0, 255);
    }
    case IMAGE_F32_2: {
        C Vec2 &v = *(Vec2 *)data;
        return Color(FltToByte(v.x), FltToByte(v.y), 0, 255);
    }
    case IMAGE_F32_3:
    case IMAGE_F32_3_SRGB: {
        C Vec &v = *(Vec *)data;
        return Color(FltToByte(v.x), FltToByte(v.y), FltToByte(v.z), 255);
    }
    case IMAGE_F32_4:
    case IMAGE_F32_4_SRGB: {
        C Vec4 &v = *(Vec4 *)data;
        return Color(FltToByte(v.x), FltToByte(v.y), FltToByte(v.z), FltToByte(v.w));
    }
    ...
    case IMAGE_F16_4: {
        C VecH4 &v = *(VecH4 *)data;
        return Color(FltToByte(v.x), FltToByte(v.y), FltToByte(v.z), FltToByte(v.w));
    }

    case IMAGE_R11G11B10F:
        return GetR11G11B10F(data);

    case IMAGE_BC6:
        return LinearToSColor(DecompressPixelBC6(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3));

    case IMAGE_BC4_SIGN: {
        SByte p = DecompressPixelBC4S(image.data() + (x >> 2) * 8 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Color(SByteToByte(p), 0, 0, 255);
    }
    case IMAGE_BC5_SIGN: {
        VecSB2 p = DecompressPixelBC5S(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Color(SByteToByte(p.x), SByteToByte(p.y), 0, 255);
    }

    case IMAGE_ETC2_R_SIGN: {
        SByte p = DecompressPixelETC2RS(image.data() + (x >> 2) * 8 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Color(SByteToByte(p), 0, 0, 255);
    }
    case IMAGE_ETC2_RG_SIGN: {
        VecSB2 p = DecompressPixelETC2RGS(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Color(SByteToByte(p.x), SByteToByte(p.y), 0, 255);
    }
...
static void SetColor(Byte *data, IMAGE_TYPE type, C Color &color) {
    ...
    case IMAGE_B8G8R8A8:
    case IMAGE_B8G8R8A8_SRGB:
        ((VecB4 *)data)->set(color.b, color.g, color.r, color.a);
        break;
    case IMAGE_B8G8R8:
    case IMAGE_B8G8R8_SRGB:
        ((VecB *)data)->set(color.b, color.g, color.r);
        break;
    case IMAGE_R8G8B8A8:
    case IMAGE_R8G8B8A8_SRGB:
        *(Color *)data = color;
    ...
    case IMAGE_R8G8B8:
    case IMAGE_R8G8B8_SRGB:
        ((VecB *)data)->set(color.r, color.g, color.b);
        break;
    case IMAGE_R8G8:
        ((VecB2 *)data)->set(color.r, color.g);
        break;
    case IMAGE_L8A8:
    case IMAGE_L8A8_SRGB:
        ((VecB2 *)data)->set(color.lum(), color.a);
        break;
    case IMAGE_L8:
    case IMAGE_L8_SRGB:
        *data = color.lum();
    ...
    case IMAGE_B4G4R4A4:
        *(U16 *)data = ((color.r >> 4) << 8) | ((color.g >> 4) << 4) | (color.b >> 4) | ((color.a >> 4) << 12);
        break;
    case IMAGE_B5G5R5A1:
        *(U16 *)data = ((color.r >> 3) << 10) | ((color.g >> 3) << 5) | (color.b >> 3) | ((color.a >> 7) << 15);
        break;
    case IMAGE_B5G6R5:
        *(U16 *)data = ((color.r >> 3) << 11) | ((color.g >> 2) << 5) | (color.b >> 3);
        break;

    case IMAGE_R8_SIGN:
        *(SByte *)data = (color.r >> 1);
        break;
    case IMAGE_R8G8_SIGN:
        ((VecSB2 *)data)->set(color.r >> 1, color.g >> 1);
        break;
    case IMAGE_R8G8B8A8_SIGN:
        ((VecSB4 *)data)->set(color.r >> 1, color.g >> 1, color.b >> 1, color.a >> 1);
        break;

    case IMAGE_R10G10B10A2:
        *(U32 *)data = ByteToU10(color.r) | (ByteToU10(color.g) << 10) | (ByteToU10(color.b) << 20) | (ByteToU2(color.a) << 30);
        break;

    case IMAGE_R11G11B10F:
        SetR11G11B10F(data, color);
        break;

    case IMAGE_F32:
        *(Flt *)data = ByteToFlt(color.r);
        break;
    case IMAGE_F32_2:
        ((Vec2 *)data)->set(ByteToFlt(color.r), ByteToFlt(color.g));
        break;
    case IMAGE_F32_3:
    case IMAGE_F32_3_SRGB:
        ((Vec *)data)->set(ByteToFlt(color.r), ByteToFlt(color.g), ByteToFlt(color.b));
        break;
    case IMAGE_F32_4:
    case IMAGE_F32_4_SRGB:
        ((Vec4 *)data)->set(ByteToFlt(color.r), ByteToFlt(color.g), ByteToFlt(color.b), ByteToFlt(color.a));
        break;

    case IMAGE_F16:
        *(Half *)data = ByteToFlt(color.r);
        break;
    case IMAGE_F16_2:
        ((VecH2 *)data)->set(ByteToFlt(color.r), ByteToFlt(color.g));
        break;
    case IMAGE_F16_3:
        ((VecH *)data)->set(ByteToFlt(color.r), ByteToFlt(color.g), ByteToFlt(color.b));
        break;
    case IMAGE_F16_4:
        ((VecH4 *)data)->set(ByteToFlt(color.r), ByteToFlt(color.g), ByteToFlt(color.b), ByteToFlt(color.a));
        break;
    }
}
static void SetColor(Byte *data, IMAGE_TYPE type, IMAGE_TYPE hw_type, C Color &color) {
    if (type == hw_type)
    normal:
        return SetColor(data, hw_type, color); // first check if types are the same, the most common case
    Color c;
    switch (type) // however if we want 'type' but we've got 'hw_type' then we have to adjust the color we're going to set. This will prevent setting different R G B values for type=IMAGE_L8 when hw_type=IMAGE_R8G8B8A8
    {
    case IMAGE_B8G8R8:
    case IMAGE_B8G8R8_SRGB:
    case IMAGE_R8G8B8:
    ...
    case IMAGE_F32_3:
    case IMAGE_F32_3_SRGB:
        c.set(color.r, color.g, color.b, 255);
        break;

    case IMAGE_R8G8:
    case IMAGE_F16_2:
    case IMAGE_F32_2:
        c.set(color.r, color.g, 0, 255);
        break;
...
static void _SetColorF(Byte *data, IMAGE_TYPE type, C Vec4 &color) {
    ...
    case IMAGE_A8:
        (*(U8 *)data) = FltToByte(color.w);
        break; // it's okay to clamp int for small values
    case IMAGE_I8:
        (*(U8 *)data) = FltToByte(color.x);
        break; // it's okay to clamp int for small values

    case IMAGE_I16:
        (*(U16 *)data) = RoundU(Sat(color.x) * 0x0000FFFFu);
        break; // it's better to clamp flt for bigger values
    case IMAGE_I32:
        (*(U32 *)data) = RoundUClamp(Sat(color.x) * 0xFFFFFFFFu);
        break; // it's better to clamp flt for bigger values
    case IMAGE_I24: {
        U32 c = RoundU(Sat(color.x) * 0x00FFFFFFu);
        (*(U16 *)data) = c;
        data[2] = (c >> 16);
    } break; // it's better to clamp flt for bigger values
    ...
    case IMAGE_L8:
    case IMAGE_L8_SRGB:
        (*(U8 *)data) = FltToByte(color.xyz.max());
        break; // it's okay to clamp int for small values
    case IMAGE_L8A8:
    case IMAGE_L8A8_SRGB:
        ((VecB2 *)data)->set(FltToByte(color.xyz.max()), FltToByte(color.w));
        break;

    case IMAGE_B8G8R8A8:
    case IMAGE_B8G8R8A8_SRGB:
        ((VecB4 *)data)->set(FltToByte(color.z), FltToByte(color.y), FltToByte(color.x), FltToByte(color.w));
        break;
    case IMAGE_R8G8B8A8:
    case IMAGE_R8G8B8A8_SRGB:
        ((VecB4 *)data)->set(FltToByte(color.x), FltToByte(color.y), FltToByte(color.z), FltToByte(color.w));
        break;
    case IMAGE_R8G8B8:
    case IMAGE_R8G8B8_SRGB:
        ((VecB *)data)->set(FltToByte(color.x), FltToByte(color.y), FltToByte(color.z));
        break;
    case IMAGE_R8G8:
        ((VecB2 *)data)->set(FltToByte(color.x), FltToByte(color.y));
        break;
    case IMAGE_R8:
        *(Byte *)data = FltToByte(color.x);
        break;
    case IMAGE_B8G8R8:
    case IMAGE_B8G8R8_SRGB:
        ((VecB *)data)->set(FltToByte(color.z), FltToByte(color.y), FltToByte(color.x));
        break;

    case IMAGE_R8_SIGN:
        *(SByte *)data = SFltToSByte(color.x);
        break;
    case IMAGE_R8G8_SIGN:
        ((VecSB2 *)data)->set(SFltToSByte(color.x), SFltToSByte(color.y));
        break;
    case IMAGE_R8G8B8A8_SIGN:
        ((VecSB4 *)data)->set(SFltToSByte(color.x), SFltToSByte(color.y), SFltToSByte(color.z), SFltToSByte(color.w));
        break;

    case IMAGE_R10G10B10A2: {
        (*(UInt *)data) = FltToU10(color.x) | (FltToU10(color.y) << 10) | (FltToU10(color.z) << 20) | (FltToU2(color.w) << 30);
    } break;

    case IMAGE_R11G11B10F:
        SetR11G11B10F(data, color.xyz);
        break;
    }
}
static void SetColorF(Byte *data, IMAGE_TYPE type, IMAGE_TYPE hw_type, C Vec4 &color) {
    if (type == hw_type)
    normal:
        return _SetColorF(data, hw_type, color); // first check if types are the same, the most common case
    Vec4 c;
    switch (type) // however if we want 'type' but we've got 'hw_type' then we have to adjust the color we're going to set. This will prevent setting different R G B values for type=IMAGE_L8 when hw_type=IMAGE_R8G8B8A8
    {
    case IMAGE_B8G8R8:
    ...
    case IMAGE_F32_3:
    case IMAGE_F32_3_SRGB:
        c.set(color.x, color.y, color.z, 1);
        break;

    case IMAGE_R8G8:
    case IMAGE_F16_2:
    case IMAGE_F32_2:
        c.set(color.x, color.y, 0, 1);
        break;
...
static void _SetColorL(Byte *data, IMAGE_TYPE type, C Vec4 &color) {
    ...
    case IMAGE_F32_3_SRGB:
        (*(Vec *)data) = LinearToSRGB(color.xyz);
        break;
    case IMAGE_F32_4_SRGB:
        (*(Vec4 *)data) = LinearToSRGB(color);
        break;
    ...
    case IMAGE_L8:
        ...
        break; // it's okay to clamp int for small values
    case IMAGE_L8_SRGB:
        (*(U8 *)data) = LinearToByteSRGB(color.xyz.max());
        break; // it's okay to clamp int for small values
    ...
    case IMAGE_L8A8:
        ...
        break;
    case IMAGE_L8A8_SRGB:
        ((VecB2 *)data)->set(LinearToByteSRGB(color.xyz.max()), FltToByte(color.w));
        break;
    ...
    case IMAGE_B8G8R8A8_SRGB:
        ((VecB4 *)data)->set(LinearToByteSRGB(color.z), LinearToByteSRGB(color.y), LinearToByteSRGB(color.x), FltToByte(color.w));
        break;
    case IMAGE_R8G8B8A8_SRGB:
        ((VecB4 *)data)->set(LinearToByteSRGB(color.x), LinearToByteSRGB(color.y), LinearToByteSRGB(color.z), FltToByte(color.w));
        break;
    case IMAGE_B8G8R8_SRGB:
        ((VecB *)data)->set(LinearToByteSRGB(color.z), LinearToByteSRGB(color.y), LinearToByteSRGB(color.x));
        break;
    case IMAGE_R8G8B8_SRGB:
        ((VecB *)data)->set(LinearToByteSRGB(color.x), LinearToByteSRGB(color.y), LinearToByteSRGB(color.z));
        break;
...
static void SetColorL(Byte *data, IMAGE_TYPE type, IMAGE_TYPE hw_type, C Vec4 &color) {
    if (type == hw_type)
    normal:
        return _SetColorL(data, hw_type, color); // first check if types are the same, the most common case
    Vec4 c;
    switch (type) // however if we want 'type' but we've got 'hw_type' then we have to adjust the color we're going to set. This will prevent setting different R G B values for type=IMAGE_L8 when hw_type=IMAGE_R8G8B8A8
    {
    case IMAGE_B8G8R8:
...
static void _SetColorS(Byte *data, IMAGE_TYPE type, C Vec4 &color) {
    switch (type) {
    case IMAGE_F32:
        (*(Flt *)data) = SRGBToLinear(color.x);
        break;
    case IMAGE_F32_2:
        (*(Vec2 *)data).set(SRGBToLinear(color.x), SRGBToLinear(color.y));
        break;
    case IMAGE_F32_3:
        (*(Vec *)data) = SRGBToLinear(color.xyz);
        break;
    case IMAGE_F32_4:
        (*(Vec4 *)data) = SRGBToLinear(color);
        break;
    ...
    case IMAGE_F16:
        (*(Half *)data) = SRGBToLinear(color.x);
        break;
    case IMAGE_F16_2:
        (*(VecH2 *)data).set(SRGBToLinear(color.x), SRGBToLinear(color.y));
        break;
    case IMAGE_F16_3:
        (*(VecH *)data) = SRGBToLinear(color.xyz);
        break;
    case IMAGE_F16_4:
        (*(VecH4 *)data) = SRGBToLinear(color);
        break;
    ...
    case IMAGE_A8:
        ...
        break; // it's okay to clamp int for small values
    case IMAGE_I8:
        (*(U8 *)data) = SRGBToLinearByte(color.x);
        break; // it's okay to clamp int for small values

    case IMAGE_I16:
        (*(U16 *)data) = RoundU(Sat(SRGBToLinear(color.x)) * 0x0000FFFFu);
        break; // it's better to clamp flt for bigger values
    case IMAGE_I32:
        (*(U32 *)data) = RoundUClamp(Sat(SRGBToLinear(color.x)) * 0xFFFFFFFFu);
        break; // it's better to clamp flt for bigger values
    case IMAGE_I24: {
        U32 c = RoundU(Sat(SRGBToLinear(color.x)) * 0x00FFFFFFu);
        (*(U16 *)data) = c;
        data[2] = (c >> 16);
    } break; // it's better to clamp flt for bigger values

    case IMAGE_L8:
        (*(U8 *)data) = SRGBToLinearByte(color.xyz.max());
        break; // it's okay to clamp int for small values
    case IMAGE_L8_SRGB:
        (*(U8 *)data) = FltToByte(color.xyz.max());
        break; // it's okay to clamp int for small values
    ...
    case IMAGE_L8A8:
        ((VecB2 *)data)->set(SRGBToLinearByte(color.xyz.max()), FltToByte(color.w));
        break;
    case IMAGE_L8A8_SRGB:
        ((VecB2 *)data)->set(FltToByte(color.xyz.max()), FltToByte(color.w));
        break;
    ...
    case IMAGE_B8G8R8A8:
        ((VecB4 *)data)->set(SRGBToLinearByte(color.z), SRGBToLinearByte(color.y), SRGBToLinearByte(color.x), FltToByte(color.w));
        break;
    case IMAGE_R8G8B8A8:
        ((VecB4 *)data)->set(SRGBToLinearByte(color.x), SRGBToLinearByte(color.y), SRGBToLinearByte(color.z), FltToByte(color.w));
        break;
    case IMAGE_R8G8B8:
        ((VecB *)data)->set(SRGBToLinearByte(color.x), SRGBToLinearByte(color.y), SRGBToLinearByte(color.z));
        break;
    case IMAGE_R8G8:
        ((VecB2 *)data)->set(SRGBToLinearByte(color.x), SRGBToLinearByte(color.y));
        break;
    case IMAGE_R8:
        *(Byte *)data = SRGBToLinearByte(color.x);
        break;
    case IMAGE_B8G8R8:
        ((VecB *)data)->set(SRGBToLinearByte(color.z), SRGBToLinearByte(color.y), SRGBToLinearByte(color.x));
        break;
    ...
    case IMAGE_R8_SIGN:
        *(SByte *)data = SFltToSByte(SignSRGBToLinear(color.x));
        break;
    case IMAGE_R8G8_SIGN:
        ((VecSB2 *)data)->set(SFltToSByte(SignSRGBToLinear(color.x)), SFltToSByte(SignSRGBToLinear(color.y)));
        break;
    case IMAGE_R8G8B8A8_SIGN:
        ((VecSB4 *)data)->set(SFltToSByte(SignSRGBToLinear(color.x)), SFltToSByte(SignSRGBToLinear(color.y)), SFltToSByte(SignSRGBToLinear(color.z)), SFltToSByte(color.w));
        break;

    case IMAGE_R10G10B10A2: {
        (*(UInt *)data) = FltToU10(SRGBToLinear(color.x)) | (FltToU10(SRGBToLinear(color.y)) << 10) | (FltToU10(SRGBToLinear(color.z)) << 20) | (FltToU2(color.w) << 30);
    } break;

    case IMAGE_R11G11B10F:
        SetR11G11B10F(data, SRGBToLinear(color.xyz));
        break;
    }
}
static void SetColorS(Byte *data, IMAGE_TYPE type, IMAGE_TYPE hw_type, C Vec4 &color) {
    if (type == hw_type)
    normal:
        return _SetColorS(data, hw_type, color); // first check if types are the same, the most common case
    Vec4 c;
    switch (type) // however if we want 'type' but we've got 'hw_type' then we have to adjust the color we're going to set. This will prevent setting different R G B values for type=IMAGE_L8 when hw_type=IMAGE_R8G8B8A8
    {
    case IMAGE_B8G8R8:
...
Vec4 ImageColorF(CPtr data, IMAGE_TYPE hw_type) {
    switch (hw_type) {
    case IMAGE_F32:
        return Vec4(*(Flt *)data, 0, 0, 1);
    case IMAGE_F32_2:
        return Vec4(*(Vec2 *)data, 0, 1);
    case IMAGE_F32_3:
    case IMAGE_F32_3_SRGB:
        return Vec4(*(Vec *)data, 1);
    case IMAGE_F32_4:
    case IMAGE_F32_4_SRGB:
        return *(Vec4 *)data;

    case IMAGE_F16:
        return Vec4(((Half *)data)[0], 0, 0, 1);
    case IMAGE_F16_2:
        return Vec4(((Half *)data)[0], ((Half *)data)[1], 0, 1);
    case IMAGE_F16_3:
        return Vec4(((Half *)data)[0], ((Half *)data)[1], ((Half *)data)[2], 1);
    case IMAGE_F16_4:
        return Vec4(((Half *)data)[0], ((Half *)data)[1], ((Half *)data)[2], ((Half *)data)[3]);

    case IMAGE_A8:
        return Vec4(0, 0, 0, ByteToFlt(*(U8 *)data));
    case IMAGE_I8:
        return Vec4(Vec(ByteToFlt(*(U8 *)data)), 1);

        // 16
#if SUPPORT_DEPTH_TO_COLOR
    case IMAGE_D16:
        if (GL)
            return Vec4(Vec((*(U16 *)data) / Flt(0x0000FFFFu) * 2 - 1), 1); // !! else fall through no break on purpose !!
#endif
    case IMAGE_I16:
    ...
    case IMAGE_D32:
    case IMAGE_D32S8X24:
        return Vec4(Vec(GL ? (*(Flt *)data) * 2 - 1 : *(Flt *)data), 1);
    ...
    case IMAGE_D24X8:
        if (GL)
            return Vec4(Vec((*(U16 *)(((Byte *)data) + 1) | (((Byte *)data)[3] << 16)) / Flt(0x00FFFFFFu) * 2 - 1), 1); // !! else fall through no break on purpose !!
#endif
    case IMAGE_I24:
    ...
    case IMAGE_L8A8_SRGB: {
        VecB2 &c = *(VecB2 *)data;
        Flt l = ByteToFlt(c.x);
        return Vec4(l, l, l, ByteToFlt(c.y));
    }

    case IMAGE_B8G8R8A8:
    case IMAGE_B8G8R8A8_SRGB: {
        VecB4 &c = *(VecB4 *)data;
        return Vec4(ByteToFlt(c.z), ByteToFlt(c.y), ByteToFlt(c.x), ByteToFlt(c.w));
    }
    case IMAGE_R8G8B8A8:
    case IMAGE_R8G8B8A8_SRGB: {
        VecB4 &c = *(VecB4 *)data;
        return Vec4(ByteToFlt(c.x), ByteToFlt(c.y), ByteToFlt(c.z), ByteToFlt(c.w));
    }
    case IMAGE_B8G8R8:
    case IMAGE_B8G8R8_SRGB: {
        VecB &c = *(VecB *)data;
        return Vec4(ByteToFlt(c.z), ByteToFlt(c.y), ByteToFlt(c.x), 1);
    }
    case IMAGE_R8G8B8:
    case IMAGE_R8G8B8_SRGB: {
        VecB &c = *(VecB *)data;
        return Vec4(ByteToFlt(c.x), ByteToFlt(c.y), ByteToFlt(c.z), 1);
    }
    case IMAGE_R8G8: {
        VecB2 &c = *(VecB2 *)data;
        return Vec4(ByteToFlt(c.x), ByteToFlt(c.y), 0, 1);
    }
    case IMAGE_R8: {
        Byte c = *(Byte *)data;
        return Vec4(ByteToFlt(c), 0, 0, 1);
    }

    case IMAGE_R8_SIGN: {
        SByte &c = *(SByte *)data;
        return Vec4(SByteToSFlt(c), 0, 0, 1);
    }
    case IMAGE_R8G8_SIGN: {
        VecSB2 &c = *(VecSB2 *)data;
        return Vec4(SByteToSFlt(c.x), SByteToSFlt(c.y), 0, 1);
    }
    case IMAGE_R8G8B8A8_SIGN: {
        VecSB4 &c = *(VecSB4 *)data;
        return Vec4(SByteToSFlt(c.x), SByteToSFlt(c.y), SByteToSFlt(c.z), SByteToSFlt(c.w));
    }

    case IMAGE_R10G10B10A2: {
        UInt u = *(UInt *)data;
        return Vec4(U10ToFlt(u & 0x3FF), U10ToFlt((u >> 10) & 0x3FF), U10ToFlt((u >> 20) & 0x3FF), U2ToFlt(u >> 30));
    }

    case IMAGE_R11G11B10F:
        return Vec4(GetR11G11B10F(data), 1);
    }
    return 0;
}
static inline Vec4 GetColorF(CPtr data, C Image &image, Bool _2d, Int x, Int y, Int z = 0) {
    ...
    case IMAGE_BC6:
        return Vec4(DecompressPixelBC6(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3), 1);

    case IMAGE_BC4_SIGN: {
        SByte p = DecompressPixelBC4S(image.data() + (x >> 2) * 8 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Vec4(SByteToSFlt(p), 0, 0, 1);
    }
    case IMAGE_BC5_SIGN: {
        VecSB2 p = DecompressPixelBC5S(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Vec4(SByteToSFlt(p.x), SByteToSFlt(p.y), 0, 1);
    }
...
Vec4 ImageColorL(CPtr data, IMAGE_TYPE hw_type) {
    ...
    case IMAGE_F32_3_SRGB:
        return Vec4(SRGBToLinear(*(Vec *)data), 1);
    case IMAGE_F32_4_SRGB:
        return SRGBToLinear(*(Vec4 *)data);
    ...
    case IMAGE_L8:
        return Vec4(Vec(ByteToFlt(*(U8 *)data)), 1);
    case IMAGE_L8_SRGB:
        return Vec4(Vec(ByteSRGBToLinear(*(U8 *)data)), 1);
    ...
    case IMAGE_B8G8R8A8_SRGB: {
        VecB4 &c = *(VecB4 *)data;
        return Vec4(ByteSRGBToLinear(c.z), ByteSRGBToLinear(c.y), ByteSRGBToLinear(c.x), ByteToFlt(c.w));
    }
    case IMAGE_R8G8B8A8_SRGB: {
        VecB4 &c = *(VecB4 *)data;
        return Vec4(ByteSRGBToLinear(c.x), ByteSRGBToLinear(c.y), ByteSRGBToLinear(c.z), ByteToFlt(c.w));
    }
    case IMAGE_B8G8R8_SRGB: {
        VecB &c = *(VecB *)data;
        return Vec4(ByteSRGBToLinear(c.z), ByteSRGBToLinear(c.y), ByteSRGBToLinear(c.x), 1);
    }
    case IMAGE_R8G8B8_SRGB: {
        VecB &c = *(VecB *)data;
        return Vec4(ByteSRGBToLinear(c.x), ByteSRGBToLinear(c.y), ByteSRGBToLinear(c.z), 1);
    }
...
static inline Vec4 GetColorS(CPtr data, C Image &image, Bool _2d, Int x, Int y, Int z = 0) {
    switch (image.hwType()) {
    case IMAGE_F32:
        return Vec4(LinearToSRGB(*(Flt *)data), 0, 0, 1);
    case IMAGE_F32_2:
        return Vec4(LinearToSRGB(((Flt *)data)[0]), LinearToSRGB(((Flt *)data)[1]), 0, 1);
    case IMAGE_F32_3:
        return Vec4(LinearToSRGB(*(Vec *)data), 1);
    case IMAGE_F32_4:
        return LinearToSRGB(*(Vec4 *)data);
    ...
    case IMAGE_F16:
        return Vec4(LinearToSRGB(((Half *)data)[0]), 0, 0, 1);
    case IMAGE_F16_2:
        return Vec4(LinearToSRGB(((Half *)data)[0]), LinearToSRGB(((Half *)data)[1]), 0, 1);
    case IMAGE_F16_3:
        return Vec4(LinearToSRGB(*(VecH *)data), 1);
    case IMAGE_F16_4:
        return LinearToSRGB(*(VecH4 *)data);

    case IMAGE_A8:
        return Vec4(0, 0, 0, ByteToFlt(*(U8 *)data));
    case IMAGE_I8:
        return Vec4(Vec(LinearByteToSRGB(*(U8 *)data)), 1);

    case IMAGE_I16:
        return Vec4(Vec(LinearToSRGB((*(U16 *)data) / Flt(0x0000FFFFu))), 1);
    case IMAGE_I32:
        return Vec4(Vec(LinearToSRGB((*(U32 *)data) / Dbl(0xFFFFFFFFu))), 1); // Dbl required to get best precision
    case IMAGE_I24:
        return Vec4(Vec(LinearToSRGB((*(U16 *)data | (((Byte *)data)[2] << 16)) / Flt(0x00FFFFFFu))), 1); // here Dbl is not required, this was tested
    ...
    case IMAGE_B8G8R8A8: {
        VecB4 &c = *(VecB4 *)data;
        return Vec4(LinearByteToSRGB(c.z), LinearByteToSRGB(c.y), LinearByteToSRGB(c.x), ByteToFlt(c.w));
    }
    case IMAGE_R8G8B8A8: {
        VecB4 &c = *(VecB4 *)data;
        return Vec4(LinearByteToSRGB(c.x), LinearByteToSRGB(c.y), LinearByteToSRGB(c.z), ByteToFlt(c.w));
    }
    case IMAGE_B8G8R8: {
        VecB &c = *(VecB *)data;
        return Vec4(LinearByteToSRGB(c.z), LinearByteToSRGB(c.y), LinearByteToSRGB(c.x), 1);
    }
    case IMAGE_R8G8B8: {
        VecB &c = *(VecB *)data;
        return Vec4(LinearByteToSRGB(c.x), LinearByteToSRGB(c.y), LinearByteToSRGB(c.z), 1);
    }
    case IMAGE_R8G8: {
        VecB2 &c = *(VecB2 *)data;
        return Vec4(LinearByteToSRGB(c.x), LinearByteToSRGB(c.y), 0, 1);
    }
    case IMAGE_R8: {
        Byte c = *(Byte *)data;
        return Vec4(LinearByteToSRGB(c), 0, 0, 1);
    }
    ...
    case IMAGE_R8_SIGN: {
        SByte &c = *(SByte *)data;
        return Vec4(SignLinearToSRGB(SByteToSFlt(c)), 0, 0, 1);
    }
    case IMAGE_R8G8_SIGN: {
        VecSB2 &c = *(VecSB2 *)data;
        return Vec4(SignLinearToSRGB(SByteToSFlt(c.x)), SignLinearToSRGB(SByteToSFlt(c.y)), 0, 1);
    }
    case IMAGE_R8G8B8A8_SIGN: {
        VecSB4 &c = *(VecSB4 *)data;
        return Vec4(SignLinearToSRGB(SByteToSFlt(c.x)), SignLinearToSRGB(SByteToSFlt(c.y)), SignLinearToSRGB(SByteToSFlt(c.z)), SByteToSFlt(c.w));
    }

    case IMAGE_R10G10B10A2: {
        UInt u = *(UInt *)data;
        return Vec4(LinearToSRGB(U10ToFlt(u & 0x3FF)), LinearToSRGB(U10ToFlt((u >> 10) & 0x3FF)), LinearToSRGB(U10ToFlt((u >> 20) & 0x3FF)), U2ToFlt(u >> 30));
    }

    case IMAGE_R11G11B10F:
        return Vec4(LinearToSRGB(GetR11G11B10F(data)), 1);

    case IMAGE_BC6:
        return Vec4(LinearToSRGB(DecompressPixelBC6(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3)), 1);

    case IMAGE_BC4_SIGN: {
        SByte p = DecompressPixelBC4S(image.data() + (x >> 2) * 8 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Vec4(SignLinearToSRGB(SByteToSFlt(p)), 0, 0, 1);
    }
    case IMAGE_BC5_SIGN: {
        VecSB2 p = DecompressPixelBC5S(image.data() + (x >> 2) * 16 + (y >> 2) * image.pitch() + (_2d ? 0 : z * image.pitch2()), x & 3, y & 3);
        return Vec4(SignLinearToSRGB(SByteToSFlt(p.x)), SignLinearToSRGB(SByteToSFlt(p.y)), 0, 1);
    }
...
Flt Image::pixelFLinear(Flt x, Flt y, Bool clamp) C {
    if (lw() && lh()) {
        ...
        return p[0][0] * (1 - x) * (1 - y) + p[0][1] * (x) * (1 - y) + p[1][0] * (1 - x) * (y) + p[1][1] * (x) * (y);
    }
    return 0;
}
Flt Image::pixelLLinear(Flt x, Flt y, Bool clamp) C {
    if (lw() && lh()) {
        ...
        Flt p[2][2];
        gatherL(&p[0][0], xo, Elms(xo), yo, Elms(yo)); // [y][x]
...
Flt Image::pixel3DFLinear(Flt x, Flt y, Flt z, Bool clamp) C {
    if (lw() && lh() && ld()) {
        ...
        return p[0][0][0] * (1 - x) * (1 - y) * (1 - z) + p[0][0][1] * (x) * (1 - y) * (1 - z) + p[0][1][0] * (1 - x) * (y) * (1 - z) + p[0][1][1] * (x) * (y) * (1 - z) + p[1][0][0] * (1 - x) * (1 - y) * (z) + p[1][0][1] * (x) * (1 - y) * (z) + p[1][1][0] * (1 - x) * (y) * (z) + p[1][1][1] * (x) * (y) * (z);
    }
    return 0;
}
/******************************************************************************/
...
Vec4 Image::colorFLinear(Flt x, Flt y, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        if (alpha_weight) {
            ...
            return c[0][0] * (1 - x) * (1 - y) + c[0][1] * (x) * (1 - y) + c[1][0] * (1 - x) * (y) + c[1][1] * (x) * (y);
    }
    return 0;
}
...
Vec4 Image::color3DFLinear(Flt x, Flt y, Flt z, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh() && ld()) {
        ...
        if (alpha_weight) {
            ...
            return c[0][0][0] * (1 - x) * (1 - y) * (1 - z) + c[0][0][1] * (x) * (1 - y) * (1 - z) + c[0][1][0] * (1 - x) * (y) * (1 - z) + c[0][1][1] * (x) * (y) * (1 - z) + c[1][0][0] * (1 - x) * (1 - y) * (z) + c[1][0][1] * (x) * (1 - y) * (z) + c[1][1][0] * (1 - x) * (y) * (z) + c[1][1][1] * (x) * (y) * (z);
    }
    return 0;
}
/******************************************************************************/
...
Flt Image::pixelFCubicFast(Flt x, Flt y, Bool clamp) C {
    if (lw() && lh()) {
        ...
        yo[0]--;
        if (clamp) {
            xo[1] = Mid(xo[0] + 1, 0, lw() - 1);
            xo[2] = Mid(xo[0] + 2, 0, lw() - 1);
            xo[3] = Mid(xo[0] + 3, 0, lw() - 1);
            Clamp(xo[0], 0, lw() - 1);
            yo[1] = Mid(yo[0] + 1, 0, lh() - 1);
            yo[2] = Mid(yo[0] + 2, 0, lh() - 1);
            yo[3] = Mid(yo[0] + 3, 0, lh() - 1);
            Clamp(yo[0], 0, lh() - 1);
        } else {
            xo[0] = Mod(xo[0], lw());
            xo[1] = (xo[0] + 1) % lw();
...
Vec4 Image::colorFCubicFast(Flt x, Flt y, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[0][0], w, alpha_weight);
            weight += w;
        }
        w = x1w + y0w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[0][1], w, alpha_weight);
            weight += w;
        }
        w = x2w + y0w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[0][2], w, alpha_weight);
            weight += w;
        }
        w = x3w + y0w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[0][3], w, alpha_weight);
            weight += w;
        }
        ...
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[1][0], w, alpha_weight);
            weight += w;
        }
        w = x1w + y1w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[1][1], w, alpha_weight);
            weight += w;
        }
        w = x2w + y1w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[1][2], w, alpha_weight);
            weight += w;
        }
        w = x3w + y1w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[1][3], w, alpha_weight);
            weight += w;
        }
        ...
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[2][0], w, alpha_weight);
            weight += w;
        }
        w = x1w + y2w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[2][1], w, alpha_weight);
            weight += w;
        }
        w = x2w + y2w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[2][2], w, alpha_weight);
            weight += w;
        }
        w = x3w + y2w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[2][3], w, alpha_weight);
            weight += w;
        }
        ...
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[3][0], w, alpha_weight);
            weight += w;
        }
        w = x1w + y3w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[3][1], w, alpha_weight);
            weight += w;
        }
        w = x2w + y3w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[3][2], w, alpha_weight);
            weight += w;
        }
        w = x3w + y3w;
        if (w < Sqr(CUBIC_FAST_RANGE)) {
            w = CubicFast2(w);
            Add(color, rgb, c[3][3], w, alpha_weight);
            weight += w;
        }
...
Vec4 Image::colorLCubicFast(Flt x, Flt y, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        Vec4 c[4][4];
        gatherL(&c[0][0], xo, Elms(xo), yo, Elms(yo)); // [y][x]
        Vec rgb = 0;
        Vec4 color = 0;
        Flt weight = 0, w,
            x0w = Sqr(x + 1), x1w = Sqr(x), x2w = Sqr(x - 1), x3w = Sqr(x - 2),
...
Vec4 Image::colorSCubicFast(Flt x, Flt y, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        Vec4 c[4][4];
        gatherS(&c[0][0], xo, Elms(xo), yo, Elms(yo)); // [y][x]
        Vec rgb = 0;
        Vec4 color = 0;
        Flt weight = 0, w,
            x0w = Sqr(x + 1), x1w = Sqr(x), x2w = Sqr(x - 1), x3w = Sqr(x - 2),
...
Flt Image::pixel3DFCubicFast(Flt x, Flt y, Flt z, Bool clamp) C {
    if (lw() && lh() && ld()) {
        ...
        REPA(xo) {
            ...
            xw[i] = Sqr(x - xo[i]);
            yo[i] = yi - CUBIC_FAST_SAMPLES + 1 + i;
            yw[i] = Sqr(y - yo[i]);
            zo[i] = zi - CUBIC_FAST_SAMPLES + 1 + i;
            zw[i] = Sqr(z - zo[i]);
            if (clamp) {
                Clamp(xo[i], 0, lw() - 1);
                Clamp(yo[i], 0, lh() - 1);
...
Flt Image::pixelFCubicPlus(Flt x, Flt y, Bool clamp) C {
    if (lw() && lh()) {
        ...
        REPA(xo) {
            ...
            xw[i] = Sqr(x - xo[i]);
            yo[i] = yi - CUBIC_PLUS_SAMPLES + 1 + i;
            yw[i] = Sqr(y - yo[i]);
            if (clamp) {
                Clamp(xo[i], 0, lw() - 1);
                Clamp(yo[i], 0, lh() - 1);
        ...
        REPAD(x, xo) {
            ...
            if (w < Sqr(CUBIC_PLUS_RANGE)) {
                w = CubicPlusMed2(w * Sqr(CUBIC_PLUS_SHARPNESS));
                v += p[y][x] * w;
                weight += w;
            }
        }
...
Flt Image::pixelFCubicPlusSharp(Flt x, Flt y, Bool clamp) C {
    if (lw() && lh()) {
        ...
        REPA(xo) {
            xo[i] = xi - CUBIC_PLUS_SHARP_SAMPLES + 1 + i;
            xw[i] = Sqr(x - xo[i]);
            yo[i] = yi - CUBIC_PLUS_SHARP_SAMPLES + 1 + i;
            yw[i] = Sqr(y - yo[i]);
            if (clamp) {
                Clamp(xo[i], 0, lw() - 1);
                Clamp(yo[i], 0, lh() - 1);
        ...
        REPAD(x, xo) {
            ...
            if (w < Sqr(CUBIC_PLUS_SHARP_RANGE)) {
                w = CubicPlusSharp2(w * Sqr(CUBIC_PLUS_SHARP_SHARPNESS));
                v += p[y][x] * w;
                weight += w;
            }
        }
...
Flt Image::pixel3DFCubicPlus(Flt x, Flt y, Flt z, Bool clamp) C {
    if (lw() && lh() && ld()) {
        ...
        REPA(xo) {
            ...
            yo[i] = yi - CUBIC_PLUS_SAMPLES + 1 + i;
            yw[i] = Sqr(y - yo[i]);
            zo[i] = zi - CUBIC_PLUS_SAMPLES + 1 + i;
            zw[i] = Sqr(z - zo[i]);
            if (clamp) {
                Clamp(xo[i], 0, lw() - 1);
                Clamp(yo[i], 0, lh() - 1);
...
Flt Image::pixel3DFCubicPlusSharp(Flt x, Flt y, Flt z, Bool clamp) C {
    if (lw() && lh() && ld()) {
        ...
        REPA(xo) {
            ...
            yo[i] = yi - CUBIC_PLUS_SHARP_SAMPLES + 1 + i;
            yw[i] = Sqr(y - yo[i]);
            zo[i] = zi - CUBIC_PLUS_SHARP_SAMPLES + 1 + i;
            zw[i] = Sqr(z - zo[i]);
            if (clamp) {
                Clamp(xo[i], 0, lw() - 1);
                Clamp(yo[i], 0, lh() - 1);
...
Vec4 Image::color3DFCubicPlus(Flt x, Flt y, Flt z, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh() && ld()) {
        ...
        REPAD(x, xo) {
            ...
            if (w < Sqr(CUBIC_PLUS_RANGE)) {
                w = CubicPlusMed2(w * Sqr(CUBIC_PLUS_SHARPNESS));
                Add(color, rgb, c[z][y][x], w, alpha_weight);
                weight += w;
            }
        }
        Normalize(color, rgb, weight, alpha_weight, ALPHA_LIMIT_CUBIC_PLUS);
...
Vec4 Image::areaColorFAverage(C Vec2 &pos, C Vec2 &size, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        if (clamp) {
            xo[0] = Mid(recti.min.x, 0, lw() - 1);
            yo[0] = Mid(recti.min.y, 0, lh() - 1);
            xo[1] = Mid(recti.max.x, 0, lw() - 1);
            yo[1] = Mid(recti.max.y, 0, lh() - 1);
        } else {
            xo[0] = Mod(recti.min.x, lw());
            yo[0] = Mod(recti.min.y, lh());
            xo[1] = Mod(recti.max.x, lw());
            yo[1] = Mod(recti.max.y, lh());
        }

        if (recti.min == recti.max)
            return colorF(xo[0], yo[0]); // if coordinates are the same, then return this pixel
        ...
        for (Int y = recti.min.y + 1; y < recti.max.y; y++)
            for (Int yo = (clamp ? Mid(y, 0, lh() - 1) : Mod(y, lh())), x = recti.min.x + 1; x < recti.max.x; x++)
                Add(color, rgb, colorF(clamp ? Mid(x, 0, lw() - 1) : Mod(x, lw()), yo), alpha_weight);
        ...
        if (recti.min.y == recti.max.y) {
            Vec4 c[2];
            gatherL(&c[0], xo, Elms(xo), yo, 1);
            Add(color, rgb, c[0], l, alpha_weight);
            Add(color, rgb, c[1], r, alpha_weight);
        } else if (recti.min.x == recti.max.x) {
            Vec4 c[2];
            gatherL(&c[0], xo, 1, yo, Elms(yo));
...
Vec4 Image::areaColorFLinear(C Vec2 &pos, C Vec2 &size, Bool clamp, Bool alpha_weight) C // this is orthogonal
{
    if (lw() && lh()) {
        ...
        Vec2 x_mul_add;
        x_mul_add.x = 1 / s.x;
        x_mul_add.y = -pos.x * x_mul_add.x;
        Vec2 y_mul_add;
        y_mul_add.x = 1 / s.y;
        y_mul_add.y = -pos.y * y_mul_add.x;
        ...
        Vec4 color = 0;
        for (Int y = y0; y <= y1; y++) {
            Flt fy = y * y_mul_add.x + y_mul_add.y;
            fy = Linear(fy);
            Int yi = (clamp ? Mid(y, 0, lh() - 1) : Mod(y, lh()));
            for (Int x = x0; x <= x1; x++) {
                Flt fx = x * x_mul_add.x + x_mul_add.y;
                fx = Linear(fx);
                Int xi = (clamp ? Mid(x, 0, lw() - 1) : Mod(x, lw()));
                fx *= fy;
                Add(color, rgb, colorF(xi, yi), fx, alpha_weight);
                weight += fx;
            }
        }
    ...
    if (lw() && lh()) {
        ...
        for (Int y = y0; y <= y1; y++) {
            ...
            for (Int x = x0; x <= x1; x++) {
                ...
                Int xi = (clamp ? Mid(x, 0, lw() - 1) : Mod(x, lw()));
                fx *= fy;
                Add(color, rgb, colorL(xi, yi), fx, alpha_weight);
                weight += fx;
            }
        }
        Normalize(color, rgb, weight, alpha_weight, ALPHA_LIMIT_LINEAR);
...
Vec4 Image::areaColorFCubicFast(C Vec2 &pos, C Vec2 &size, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        Vec2 x_mul_add;
        x_mul_add.x = CUBIC_FAST_RANGE / size_a.x;
        x_mul_add.y = -pos.x * x_mul_add.x;
        Vec2 y_mul_add;
        y_mul_add.x = CUBIC_FAST_RANGE / size_a.y;
        y_mul_add.y = -pos.y * y_mul_add.x;
        ...
        Vec4 color = 0;
        for (Int y = y0; y <= y1; y++) {
            Flt fy2 = Sqr(y * y_mul_add.x + y_mul_add.y);
            Int yi = (clamp ? Mid(y, 0, lh() - 1) : Mod(y, lh()));
            for (Int x = x0; x <= x1; x++) {
                ...
                if (w < Sqr(CUBIC_FAST_RANGE)) {
                    w = CubicFast2(w);
                    Int xi = (clamp ? Mid(x, 0, lw() - 1) : Mod(x, lw()));
                    Add(color, rgb, colorF(xi, yi), w, alpha_weight);
                    weight += w;
                }
            }
        }
        ...
        for (Int y = y0; y <= y1; y++) {
            ...
            for (Int x = x0; x <= x1; x++) {
                ...
                if (w < Sqr(CUBIC_FAST_RANGE)) {
                    w = CubicFast2(w);
                    Int xi = (clamp ? Mid(x, 0, lw() - 1) : Mod(x, lw()));
                    Add(color, rgb, colorL(xi, yi), w, alpha_weight);
                    weight += w;
                }
            }
        }
...
Vec4 Image::areaColorFCubicPlus(C Vec2 &pos, C Vec2 &size, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        Vec2 x_mul_add;
        x_mul_add.x = CUBIC_PLUS_RANGE / size_a.x;
        x_mul_add.y = -pos.x * x_mul_add.x;
        Vec2 y_mul_add;
        y_mul_add.x = CUBIC_PLUS_RANGE / size_a.y;
        y_mul_add.y = -pos.y * y_mul_add.x;
...
Vec4 Image::areaColorFCubicPlusSharp(C Vec2 &pos, C Vec2 &size, Bool clamp, Bool alpha_weight) C {
    if (lw() && lh()) {
        ...
        Vec2 x_mul_add;
        x_mul_add.x = CUBIC_PLUS_SHARP_RANGE / size_a.x;
        x_mul_add.y = -pos.x * x_mul_add.x;
        Vec2 y_mul_add;
        y_mul_add.x = CUBIC_PLUS_SHARP_RANGE / size_a.y;
        y_mul_add.y = -pos.y * y_mul_add.x;
...
Flt Image::cubePixelFNearest(C Vec &dir, Bool linear) C {
    if (mode() == IMAGE_SOFT_CUBE) {
        ...
        Vec2 xy;
        DIR_ENUM face = (linear ? DirToCubeFacePixel : DirToSphereCubeFacePixel)(dir, w(), xy);
...
Flt Image::cubePixelFLinear(C Vec &dir, Bool linear) C {
    if (mode() == IMAGE_SOFT_CUBE) {
        ...
        SphereArea sa;
        Vec2 xy;
        sa.side = (linear ? DirToCubeFacePixel : DirToSphereCubeFacePixel)(dir, w(), xy); // calculate main face
        VecI2 xyi = Floor(xy);
        xy -= xyi;
    ...
    if (mode() == IMAGE_SOFT_CUBE) {
        ...
        FREPD(sy, 4) {
            ...
            FREPD(sx, 4) {
                sa.x = xyi.x + sx;
                Flt weight_x = weights_x[sx];
                Flt wgt = weight_x + weight_y;
                if (wgt < Sqr(CUBIC_FAST_RANGE)) {
                    Bool in_range_x = InRange(sa.x, w());
                    CPtr d;
                    if (in_range_x && in_range_y)
                        d = y_data + sa.x * byte_pp;
...
static INLINE void RangeAssertY(Int *y_offset, Int y_offsets, C Image &img) {
    if (DEBUG)
        RangeAssert(y_offset, y_offsets, img.lh());
}
static INLINE void RangeAssertZ(Int *z_offset, Int z_offsets, C Image &img) {
    if (DEBUG)
        RangeAssert(z_offset, z_offsets, img.ld());
}
/******************************************************************************/
void Image::gather(Flt *pixels, Int *x_offset, Int x_offsets, Int *y_offset, Int y_offsets) C {
    ...
    case IMAGE_B8G8R8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                *pixels++ = ByteToFlt(src.b);
            }
        }
        break;
    ...
    case IMAGE_R8G8B8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C VecB &src = color[x_offset[x]];
                *pixels++ = ByteToFlt(src.x);
            }
        }
        break;
...
void Image::gather(Color *colors, Int *x_offset, Int x_offsets, Int *y_offset, Int y_offsets) C {
    ...
    case IMAGE_B8G8R8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(src.b, src.g, src.r, src.a);
            }
        }
        break;
...
void Image::gather(Vec2 *colors, Int *x_offset, Int x_offsets, Int *y_offset, Int y_offsets) C {
    ...
    case IMAGE_B8G8R8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(ByteToFlt(src.b), ByteToFlt(src.g));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(ByteToFlt(src.r), ByteToFlt(src.g));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C VecB &src = color[x_offset[x]];
                (colors++)->set(ByteToFlt(src.x), ByteToFlt(src.y));
            }
        }
        break;
    ...
    case IMAGE_I8:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Byte &src = color[x_offset[x]];
                (colors++)->set(ByteToFlt(src), 0);
            }
        }
        break;
    ...
    case IMAGE_R8G8B8A8_SIGN:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C VecSB4 &src = color[x_offset[x]];
                (colors++)->set(SByteToSFlt(src.x), SByteToSFlt(src.y));
            }
        }
        break;
    ...
    case IMAGE_R8_SIGN:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C SByte &src = color[x_offset[x]];
                (colors++)->set(SByteToSFlt(src), 0);
            }
        }
        break;
...
void Image::gather(Vec4 *colors, Int *x_offset, Int x_offsets, Int *y_offset, Int y_offsets) C {
    ...
    case IMAGE_B8G8R8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(ByteToFlt(src.b), ByteToFlt(src.g), ByteToFlt(src.r), ByteToFlt(src.a));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(ByteToFlt(src.r), ByteToFlt(src.g), ByteToFlt(src.b), ByteToFlt(src.a));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C VecB &src = color[x_offset[x]];
                (colors++)->set(ByteToFlt(src.x), ByteToFlt(src.y), ByteToFlt(src.z), 1);
            }
        }
        break;
    ...
    case IMAGE_L8A8:
    case IMAGE_L8A8_SRGB:
        FREPD(y, y_offsets) // used for soft text drawing
        {
            C VecB2 *color = (VecB2 *)(data() + y_offset[y] * pitch());
            FREPD(x, x_offsets) {
                C VecB2 &src = color[x_offset[x]];
                Flt l = ByteToFlt(src.x);
                (colors++)->set(l, l, l, ByteToFlt(src.y));
            }
        }
        break;
...
void Image::gatherL(Vec4 *colors, Int *x_offset, Int x_offsets, Int *y_offset, Int y_offsets) C {
    ...
    case IMAGE_B8G8R8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(ByteSRGBToLinear(src.b), ByteSRGBToLinear(src.g), ByteSRGBToLinear(src.r), ByteToFlt(src.a));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8A8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(ByteSRGBToLinear(src.r), ByteSRGBToLinear(src.g), ByteSRGBToLinear(src.b), ByteToFlt(src.a));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8_SRGB:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C VecB &src = color[x_offset[x]];
                (colors++)->set(ByteSRGBToLinear(src.x), ByteSRGBToLinear(src.y), ByteSRGBToLinear(src.z), 1);
            }
        }
        break;
    ...
    case IMAGE_F32_3_SRGB:
        FREPD(y, y_offsets) {
            C Vec *color = (Vec *)(data() + y_offset[y] * pitch());
            FREPD(x, x_offsets)
            (colors++)->set(SRGBToLinear(color[x_offset[x]]), 1);
        }
        break;
...
void Image::gatherS(Vec4 *colors, Int *x_offset, Int x_offsets, Int *y_offset, Int y_offsets) C {
    ...
    case IMAGE_B8G8R8A8:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(LinearByteToSRGB(src.b), LinearByteToSRGB(src.g), LinearByteToSRGB(src.r), ByteToFlt(src.a));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8A8:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C Color &src = color[x_offset[x]];
                (colors++)->set(LinearByteToSRGB(src.r), LinearByteToSRGB(src.g), LinearByteToSRGB(src.b), ByteToFlt(src.a));
            }
        }
        break;
    ...
    case IMAGE_R8G8B8:
        FREPD(y, y_offsets) {
            ...
            FREPD(x, x_offsets) {
                C VecB &src = color[x_offset[x]];
                (colors++)->set(LinearByteToSRGB(src.x), LinearByteToSRGB(src.y), LinearByteToSRGB(src.z), 1);
            }
        }
        break;
    ...
    case IMAGE_F32_3:
        FREPD(y, y_offsets) {
            C Vec *color = (Vec *)(data() + y_offset[y] * pitch());
            FREPD(x, x_offsets)
            (colors++)->set(LinearToSRGB(color[x_offset[x]]), 1);
        }
        break;
...
void Image::gather(Flt *pixels, Int *x_offset, Int x_offsets, Int *y_offset, Int y_offsets, Int *z_offset, Int z_offsets) C {
    ...
    case IMAGE_F32:
        FREPD(z, z_offsets) {
            C Byte *data_z = data() + z_offset[z] * pitch2();
            FREPD(y, y_offsets) {
    ...
    case IMAGE_B8G8R8A8_SRGB:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                ...
                FREPD(x, x_offsets) {
                    C Color &src = color_y[x_offset[x]];
                    *pixels++ = ByteToFlt(src.b);
                }
            }
        }
    ...
    case IMAGE_R8G8:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                ...
                FREPD(x, x_offsets) {
                    C VecB2 &src = color_y[x_offset[x]];
                    (colors++)->set(ByteToFlt(src.x), ByteToFlt(src.y));
                }
            }
        }
    ...
    case IMAGE_R8G8B8A8_SIGN:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                ...
                FREPD(x, x_offsets) {
                    C VecSB4 &src = color_y[x_offset[x]];
                    (colors++)->set(SByteToSFlt(src.x), SByteToSFlt(src.y));
                }
            }
        }
    ...
    case IMAGE_R8G8_SIGN:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                ...
                FREPD(x, x_offsets) {
                    C VecSB2 &src = color_y[x_offset[x]];
                    (colors++)->set(SByteToSFlt(src.x), SByteToSFlt(src.y));
                }
            }
        }
    ...
    case IMAGE_R8_SIGN:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                ...
                FREPD(x, x_offsets) {
                    C SByte &src = color_y[x_offset[x]];
                    (colors++)->set(SByteToSFlt(src), 0);
                }
            }
        }
    ...
    case IMAGE_F32:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                ...
                FREPD(x, x_offsets)
                (colors++)->set(color_y[x_offset[x]], 0);
            }
        }
        break;
    ...
    case IMAGE_F32_3_SRGB:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                C Vec *color_y = (Vec *)(data_z + y_offset[y] * pitch());
                FREPD(x, x_offsets)
                (colors++)->set(color_y[x_offset[x]], 1);
            }
        }
        break;
    ...
    case IMAGE_F32_3_SRGB:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                C Vec *color_y = (Vec *)(data_z + y_offset[y] * pitch());
                FREPD(x, x_offsets)
                (colors++)->set(SRGBToLinear(color_y[x_offset[x]]), 1);
            }
        }
        break;
    ...
    case IMAGE_F32_3:
        FREPD(z, z_offsets) {
            ...
            FREPD(y, y_offsets) {
                C Vec *color_y = (Vec *)(data_z + y_offset[y] * pitch());
                FREPD(x, x_offsets)
                (colors++)->set(LinearToSRGB(color_y[x_offset[x]]), 1);
            }
        }
        break;
...
void CopyNoStretch(C Image &src, Image &dest, Bool clamp, Bool ignore_gamma) // assumes 'src', 'dest' are locked and non-compressed
{
    ...
    if (CanDoRawCopy(src, dest, ignore_gamma))                           // no retype
    {
        ...
        FREPD(z, d) {
            ...
            if (high_precision)
                for (Int y = h; y < dest.lh(); y++)
                    for (Int x = 0; x < dest.lw(); x++)
                        dest.color3DF(x, y, z, clamp ? src.color3DF(Min(x, src.lw() - 1), Min(y, src.lh() - 1), Min(z, src.ld() - 1)) : src.color3DF(x % src.lw(), y % src.lh(), z % src.ld()));
            else
                for (Int y = h; y < dest.lh(); y++)
                    for (Int x = 0; x < dest.lw(); x++)
        ...
        if (high_precision)
            for (Int z = d; z < dest.ld(); z++)
                for (Int y = 0; y < dest.lh(); y++)
                    for (Int x = 0; x < dest.lw(); x++)
                        dest.color3DF(x, y, z, clamp ? src.color3DF(Min(x, src.lw() - 1), Min(y, src.lh() - 1), Min(z, src.ld() - 1)) : src.color3DF(x % src.lw(), y % src.lh(), z % src.ld()));
        else
            for (Int z = d; z < dest.ld(); z++)
...
struct CopyContext {
    ...
    void downsize2xLinear(Int y) {
        Int yc[2];
        yc[0] = y * 2;
        yc[1] = (clamp ? Min(yc[0] + 1, src.lh() - 1) : (yc[0] + 1) % src.lh()); // yc[0] is always OK
        ...
        FREPD(x, dest.lw()) // iterate forward so we can increase pointers
        {
            Int xc[2];
            xc[0] = x * 2;
            xc[1] = (clamp ? Min(xc[0] + 1, src.lw() - 1) : (xc[0] + 1) % src.lw()); // xc[0] is always OK
            if (hp) {
                Vec4 col, c[2][2];
                src.gatherL(&c[0][0], xc, Elms(xc), yc, Elms(yc)); // [y][x]
                if (!alpha_weight) {
                ...
                Color col, c[2][2];
                src.gather(&c[0][0], xc, Elms(xc), yc, Elms(yc)); // [y][x]
                if (!alpha_weight) {
    ...
    void downsize2xLinear3D(IntPtr elm_index) {
        ...
        Int zc[2];
        zc[0] = z * 2;
        zc[1] = (clamp ? Min(zc[0] + 1, src.ld() - 1) : (zc[0] + 1) % src.ld()); // zc[0] is always OK
        Int yc[2];
        yc[0] = y * 2;
        yc[1] = (clamp ? Min(yc[0] + 1, src.lh() - 1) : (yc[0] + 1) % src.lh()); // yc[0] is always OK
        REPD(x, dest.lw()) {
            ...
            xc[1] = (clamp ? Min(xc[0] + 1, src.lw() - 1) : (xc[0] + 1) % src.lw()); // xc[0] is always OK
            Color col, c[2][2][2];
            src.gather(&c[0][0][0], xc, Elms(xc), yc, Elms(yc), zc, Elms(zc)); // [z][y][x]
            if (!alpha_weight) {
    ...
    void downsize2xCubicFastSharp(Int y) {
        Int yc[8];
        yc[3] = y * 2; // 'y[3]' is always OK
        if (clamp) {
            yc[0] = Max(yc[3] - 3, 0);
            yc[1] = Max(yc[3] - 2, 0);
            yc[2] = Max(yc[3] - 1, 0);
            yc[4] = Min(yc[3] + 1, src.lh() - 1);
            yc[5] = Min(yc[3] + 2, src.lh() - 1);
            yc[6] = Min(yc[3] + 3, src.lh() - 1);
            yc[7] = Min(yc[3] + 4, src.lh() - 1);
        } else {
            yc[0] = Mod(yc[3] - 3, src.lh());
            yc[1] = Mod(yc[3] - 2, src.lh());
            yc[2] = Mod(yc[3] - 1, src.lh());
            yc[4] = (yc[3] + 1) % src.lh();
            yc[5] = (yc[3] + 2) % src.lh();
            yc[6] = (yc[3] + 3) % src.lh();
            yc[7] = (yc[3] + 4) % src.lh();
        ...
        REPD(x, dest.lw()) {
            Int xc[8];
            xc[3] = x * 2; // 'x[3]' is always OK
            if (clamp) {
                xc[0] = Max(xc[3] - 3, 0);
                xc[1] = Max(xc[3] - 2, 0);
                xc[2] = Max(xc[3] - 1, 0);
                xc[4] = Min(xc[3] + 1, src.lw() - 1);
                xc[5] = Min(xc[3] + 2, src.lw() - 1);
                xc[6] = Min(xc[3] + 3, src.lw() - 1);
                xc[7] = Min(xc[3] + 4, src.lw() - 1);
            } else {
                xc[0] = Mod(xc[3] - 3, src.lw());
                xc[1] = Mod(xc[3] - 2, src.lw());
                xc[2] = Mod(xc[3] - 1, src.lw());
                xc[4] = (xc[3] + 1) % src.lw();
                xc[5] = (xc[3] + 2) % src.lw();
                xc[6] = (xc[3] + 3) % src.lw();
                xc[7] = (xc[3] + 4) % src.lw();
            ...
            if (!alpha_weight) {
                col.a = Mid((/*c[0][0].a*CW8[0][0]  + c[0][1].a*CW8[0][1]*/ +c[0][2].a * CW8[0][2] + c[0][3].a * CW8[0][3] + c[0][4].a * CW8[0][4] + c[0][5].a * CW8[0][5] +                            /*c[0][6].a*CW8[0][6] +  c[0][7].a*CW8[0][7]*/
                             ...
                             +c[2][0].a * CW8[2][0] + c[2][1].a * CW8[2][1] + c[2][2].a * CW8[2][2] + c[2][3].a * CW8[2][3] + c[2][4].a * CW8[2][4] + c[2][5].a * CW8[2][5] + c[2][6].a * CW8[2][6] + c[2][7].a * CW8[2][7] + c[3][0].a * CW8[3][0] + c[3][1].a * CW8[3][1] + c[3][2].a * CW8[3][2] + c[3][3].a * CW8[3][3] + c[3][4].a * CW8[3][4] + c[3][5].a * CW8[3][5] + c[3][6].a * CW8[3][6] + c[3][7].a * CW8[3][7] + c[4][0].a * CW8[4][0] + c[4][1].a * CW8[4][1] + c[4][2].a * CW8[4][2] + c[4][3].a * CW8[4][3] + c[4][4].a * CW8[4][4] + c[4][5].a * CW8[4][5] + c[4][6].a * CW8[4][6] + c[4][7].a * CW8[4][7] + c[5][0].a * CW8[5][0] + c[5][1].a * CW8[5][1] + c[5][2].a * CW8[5][2] + c[5][3].a * CW8[5][3] + c[5][4].a * CW8[5][4] + c[5][5].a * CW8[5][5] + c[5][6].a * CW8[5][6] + c[5][7].a * CW8[5][7]
                             /*+ c[6][0].a*CW8[6][0]*/
                             + c[6][1].a * CW8[6][1] + c[6][2].a * CW8[6][2] + c[6][3].a * CW8[6][3] + c[6][4].a * CW8[6][4] + c[6][5].a * CW8[6][5] + c[6][6].a * CW8[6][6] + /*c[6][7].a*CW8[6][7]*/
                             /*+ c[7][0].a*CW8[7][0]  + c[7][1].a*CW8[7][1]*/ +c[7][2].a * CW8[7][2] + c[7][3].a * CW8[7][3] + c[7][4].a * CW8[7][4] + c[7][5].a * CW8[7][5] + /*c[7][6].a*CW8[7][6] +  c[7][7].a*CW8[7][7]*/ +CW8Sum / 2) /
                                CW8Sum,
                            0, 255);
            rgb:
                col.r = Mid((/*c[0][0].r*CW8[0][0]  + c[0][1].r*CW8[0][1]*/ +c[0][2].r * CW8[0][2] + c[0][3].r * CW8[0][3] + c[0][4].r * CW8[0][4] + c[0][5].r * CW8[0][5] +                            /*c[0][6].r*CW8[0][6] +  c[0][7].r*CW8[0][7]*/
                             ...
                             +c[2][0].r * CW8[2][0] + c[2][1].r * CW8[2][1] + c[2][2].r * CW8[2][2] + c[2][3].r * CW8[2][3] + c[2][4].r * CW8[2][4] + c[2][5].r * CW8[2][5] + c[2][6].r * CW8[2][6] + c[2][7].r * CW8[2][7] + c[3][0].r * CW8[3][0] + c[3][1].r * CW8[3][1] + c[3][2].r * CW8[3][2] + c[3][3].r * CW8[3][3] + c[3][4].r * CW8[3][4] + c[3][5].r * CW8[3][5] + c[3][6].r * CW8[3][6] + c[3][7].r * CW8[3][7] + c[4][0].r * CW8[4][0] + c[4][1].r * CW8[4][1] + c[4][2].r * CW8[4][2] + c[4][3].r * CW8[4][3] + c[4][4].r * CW8[4][4] + c[4][5].r * CW8[4][5] + c[4][6].r * CW8[4][6] + c[4][7].r * CW8[4][7] + c[5][0].r * CW8[5][0] + c[5][1].r * CW8[5][1] + c[5][2].r * CW8[5][2] + c[5][3].r * CW8[5][3] + c[5][4].r * CW8[5][4] + c[5][5].r * CW8[5][5] + c[5][6].r * CW8[5][6] + c[5][7].r * CW8[5][7]
                             /*+ c[6][0].r*CW8[6][0]*/
                             + c[6][1].r * CW8[6][1] + c[6][2].r * CW8[6][2] + c[6][3].r * CW8[6][3] + c[6][4].r * CW8[6][4] + c[6][5].r * CW8[6][5] + c[6][6].r * CW8[6][6] + /*c[6][7].r*CW8[6][7]*/
                             /*+ c[7][0].r*CW8[7][0]  + c[7][1].r*CW8[7][1]*/ +c[7][2].r * CW8[7][2] + c[7][3].r * CW8[7][3] + c[7][4].r * CW8[7][4] + c[7][5].r * CW8[7][5] + /*c[7][6].r*CW8[7][6] +  c[7][7].r*CW8[7][7]*/ +CW8Sum / 2) /
                                CW8Sum,
                            0, 255);
                col.g = Mid((/*c[0][0].g*CW8[0][0]  + c[0][1].g*CW8[0][1]*/ +c[0][2].g * CW8[0][2] + c[0][3].g * CW8[0][3] + c[0][4].g * CW8[0][4] + c[0][5].g * CW8[0][5] +                            /*c[0][6].g*CW8[0][6] +  c[0][7].g*CW8[0][7]*/
                             ...
                             +c[2][0].g * CW8[2][0] + c[2][1].g * CW8[2][1] + c[2][2].g * CW8[2][2] + c[2][3].g * CW8[2][3] + c[2][4].g * CW8[2][4] + c[2][5].g * CW8[2][5] + c[2][6].g * CW8[2][6] + c[2][7].g * CW8[2][7] + c[3][0].g * CW8[3][0] + c[3][1].g * CW8[3][1] + c[3][2].g * CW8[3][2] + c[3][3].g * CW8[3][3] + c[3][4].g * CW8[3][4] + c[3][5].g * CW8[3][5] + c[3][6].g * CW8[3][6] + c[3][7].g * CW8[3][7] + c[4][0].g * CW8[4][0] + c[4][1].g * CW8[4][1] + c[4][2].g * CW8[4][2] + c[4][3].g * CW8[4][3] + c[4][4].g * CW8[4][4] + c[4][5].g * CW8[4][5] + c[4][6].g * CW8[4][6] + c[4][7].g * CW8[4][7] + c[5][0].g * CW8[5][0] + c[5][1].g * CW8[5][1] + c[5][2].g * CW8[5][2] + c[5][3].g * CW8[5][3] + c[5][4].g * CW8[5][4] + c[5][5].g * CW8[5][5] + c[5][6].g * CW8[5][6] + c[5][7].g * CW8[5][7]
                             /*+ c[6][0].g*CW8[6][0]*/
                             + c[6][1].g * CW8[6][1] + c[6][2].g * CW8[6][2] + c[6][3].g * CW8[6][3] + c[6][4].g * CW8[6][4] + c[6][5].g * CW8[6][5] + c[6][6].g * CW8[6][6] + /*c[6][7].g*CW8[6][7]*/
                             /*+ c[7][0].g*CW8[7][0]  + c[7][1].g*CW8[7][1]*/ +c[7][2].g * CW8[7][2] + c[7][3].g * CW8[7][3] + c[7][4].g * CW8[7][4] + c[7][5].g * CW8[7][5] + /*c[7][6].g*CW8[7][6] +  c[7][7].g*CW8[7][7]*/ +CW8Sum / 2) /
                                CW8Sum,
                            0, 255);
                col.b = Mid((/*c[0][0].b*CW8[0][0]  + c[0][1].b*CW8[0][1]*/ +c[0][2].b * CW8[0][2] + c[0][3].b * CW8[0][3] + c[0][4].b * CW8[0][4] + c[0][5].b * CW8[0][5] +                            /*c[0][6].b*CW8[0][6] +  c[0][7].b*CW8[0][7]*/
                             ...
                             +c[2][0].b * CW8[2][0] + c[2][1].b * CW8[2][1] + c[2][2].b * CW8[2][2] + c[2][3].b * CW8[2][3] + c[2][4].b * CW8[2][4] + c[2][5].b * CW8[2][5] + c[2][6].b * CW8[2][6] + c[2][7].b * CW8[2][7] + c[3][0].b * CW8[3][0] + c[3][1].b * CW8[3][1] + c[3][2].b * CW8[3][2] + c[3][3].b * CW8[3][3] + c[3][4].b * CW8[3][4] + c[3][5].b * CW8[3][5] + c[3][6].b * CW8[3][6] + c[3][7].b * CW8[3][7] + c[4][0].b * CW8[4][0] + c[4][1].b * CW8[4][1] + c[4][2].b * CW8[4][2] + c[4][3].b * CW8[4][3] + c[4][4].b * CW8[4][4] + c[4][5].b * CW8[4][5] + c[4][6].b * CW8[4][6] + c[4][7].b * CW8[4][7] + c[5][0].b * CW8[5][0] + c[5][1].b * CW8[5][1] + c[5][2].b * CW8[5][2] + c[5][3].b * CW8[5][3] + c[5][4].b * CW8[5][4] + c[5][5].b * CW8[5][5] + c[5][6].b * CW8[5][6] + c[5][7].b * CW8[5][7]
                             /*+ c[6][0].b*CW8[6][0]*/
                             + c[6][1].b * CW8[6][1] + c[6][2].b * CW8[6][2] + c[6][3].b * CW8[6][3] + c[6][4].b * CW8[6][4] + c[6][5].b * CW8[6][5] + c[6][6].b * CW8[6][6] + /*c[6][7].b*CW8[6][7]*/
                             /*+ c[7][0].b*CW8[7][0]  + c[7][1].b*CW8[7][1]*/ +c[7][2].b * CW8[7][2] + c[7][3].b * CW8[7][3] + c[7][4].b * CW8[7][4] + c[7][5].b * CW8[7][5] + /*c[7][6].b*CW8[7][6] +  c[7][7].b*CW8[7][7]*/ +CW8Sum / 2) /
                                CW8Sum,
                            0, 255);
            } else {
                ...
                Int total_alpha_weight = /*w[0][0]  + w[0][1]*/ +w[0][2] + w[0][3] + w[0][4] + w[0][5] /*+ w[0][6]  + w[0][7]*/
                                         ...
                                         + w[2][0] + w[2][1] + w[2][2] + w[2][3] + w[2][4] + w[2][5] + w[2][6] + w[2][7] + w[3][0] + w[3][1] + w[3][2] + w[3][3] + w[3][4] + w[3][5] + w[3][6] + w[3][7] + w[4][0] + w[4][1] + w[4][2] + w[4][3] + w[4][4] + w[4][5] + w[4][6] + w[4][7] + w[5][0] + w[5][1] + w[5][2] + w[5][3] + w[5][4] + w[5][5] + w[5][6] + w[5][7]
                                         /*+ w[6][0]*/
                                         + w[6][1] + w[6][2] + w[6][3] + w[6][4] + w[6][5] + w[6][6] /*+ w[6][7]*/
                                                                                                     /*+ w[7][0]  + w[7][1]*/
                                         + w[7][2] + w[7][3] + w[7][4] + w[7][5] /*+ w[7][6]  + w[7][7]*/;
                if (total_alpha_weight <= 0) {
                    col.a = 0;
                    goto rgb;
                }
                ...
                if (total_alpha_weight < CWA8AlphaLimit)                 // below this limit, lerp to RGB
                {
                    ...
                    REPD(y, 8)
                    REPD(x, 8)
                    w[y][x] = Round(CWA8[y][x] * (c[y][x].a * blend + blend1));
                ...
                col.r = Mid((/*c[0][0].r*w[0][0]  + c[0][1].r*w[0][1]*/ +c[0][2].r * w[0][2] + c[0][3].r * w[0][3] + c[0][4].r * w[0][4] + c[0][5].r * w[0][5] +                          /*c[0][6].r*w[0][6] +  c[0][7].r*w[0][7]*/
                             ...
                             +c[2][0].r * w[2][0] + c[2][1].r * w[2][1] + c[2][2].r * w[2][2] + c[2][3].r * w[2][3] + c[2][4].r * w[2][4] + c[2][5].r * w[2][5] + c[2][6].r * w[2][6] + c[2][7].r * w[2][7] + c[3][0].r * w[3][0] + c[3][1].r * w[3][1] + c[3][2].r * w[3][2] + c[3][3].r * w[3][3] + c[3][4].r * w[3][4] + c[3][5].r * w[3][5] + c[3][6].r * w[3][6] + c[3][7].r * w[3][7] + c[4][0].r * w[4][0] + c[4][1].r * w[4][1] + c[4][2].r * w[4][2] + c[4][3].r * w[4][3] + c[4][4].r * w[4][4] + c[4][5].r * w[4][5] + c[4][6].r * w[4][6] + c[4][7].r * w[4][7] + c[5][0].r * w[5][0] + c[5][1].r * w[5][1] + c[5][2].r * w[5][2] + c[5][3].r * w[5][3] + c[5][4].r * w[5][4] + c[5][5].r * w[5][5] + c[5][6].r * w[5][6] + c[5][7].r * w[5][7]
                             /*+ c[6][0].r*w[6][0]*/
                             + c[6][1].r * w[6][1] + c[6][2].r * w[6][2] + c[6][3].r * w[6][3] + c[6][4].r * w[6][4] + c[6][5].r * w[6][5] + c[6][6].r * w[6][6] + /*c[6][7].r*w[6][7]*/
                             /*+ c[7][0].r*w[7][0]  + c[7][1].r*w[7][1]*/ +c[7][2].r * w[7][2] + c[7][3].r * w[7][3] + c[7][4].r * w[7][4] + c[7][5].r * w[7][5] + /*c[7][6].r*w[7][6] +  c[7][7].r*w[7][7]*/ +round) /
                                total_alpha_weight,
                            0, 255);
                col.g = Mid((/*c[0][0].g*w[0][0]  + c[0][1].g*w[0][1]*/ +c[0][2].g * w[0][2] + c[0][3].g * w[0][3] + c[0][4].g * w[0][4] + c[0][5].g * w[0][5] +                          /*c[0][6].g*w[0][6] +  c[0][7].g*w[0][7]*/
                             ...
                             +c[2][0].g * w[2][0] + c[2][1].g * w[2][1] + c[2][2].g * w[2][2] + c[2][3].g * w[2][3] + c[2][4].g * w[2][4] + c[2][5].g * w[2][5] + c[2][6].g * w[2][6] + c[2][7].g * w[2][7] + c[3][0].g * w[3][0] + c[3][1].g * w[3][1] + c[3][2].g * w[3][2] + c[3][3].g * w[3][3] + c[3][4].g * w[3][4] + c[3][5].g * w[3][5] + c[3][6].g * w[3][6] + c[3][7].g * w[3][7] + c[4][0].g * w[4][0] + c[4][1].g * w[4][1] + c[4][2].g * w[4][2] + c[4][3].g * w[4][3] + c[4][4].g * w[4][4] + c[4][5].g * w[4][5] + c[4][6].g * w[4][6] + c[4][7].g * w[4][7] + c[5][0].g * w[5][0] + c[5][1].g * w[5][1] + c[5][2].g * w[5][2] + c[5][3].g * w[5][3] + c[5][4].g * w[5][4] + c[5][5].g * w[5][5] + c[5][6].g * w[5][6] + c[5][7].g * w[5][7]
                             /*+ c[6][0].g*w[6][0]*/
                             + c[6][1].g * w[6][1] + c[6][2].g * w[6][2] + c[6][3].g * w[6][3] + c[6][4].g * w[6][4] + c[6][5].g * w[6][5] + c[6][6].g * w[6][6] + /*c[6][7].g*w[6][7]*/
                             /*+ c[7][0].g*w[7][0]  + c[7][1].g*w[7][1]*/ +c[7][2].g * w[7][2] + c[7][3].g * w[7][3] + c[7][4].g * w[7][4] + c[7][5].g * w[7][5] + /*c[7][6].g*w[7][6] +  c[7][7].g*w[7][7]*/ +round) /
                                total_alpha_weight,
                            0, 255);
                col.b = Mid((/*c[0][0].b*w[0][0]  + c[0][1].b*w[0][1]*/ +c[0][2].b * w[0][2] + c[0][3].b * w[0][3] + c[0][4].b * w[0][4] + c[0][5].b * w[0][5] +                          /*c[0][6].b*w[0][6] +  c[0][7].b*w[0][7]*/
                             ...
                             +c[2][0].b * w[2][0] + c[2][1].b * w[2][1] + c[2][2].b * w[2][2] + c[2][3].b * w[2][3] + c[2][4].b * w[2][4] + c[2][5].b * w[2][5] + c[2][6].b * w[2][6] + c[2][7].b * w[2][7] + c[3][0].b * w[3][0] + c[3][1].b * w[3][1] + c[3][2].b * w[3][2] + c[3][3].b * w[3][3] + c[3][4].b * w[3][4] + c[3][5].b * w[3][5] + c[3][6].b * w[3][6] + c[3][7].b * w[3][7] + c[4][0].b * w[4][0] + c[4][1].b * w[4][1] + c[4][2].b * w[4][2] + c[4][3].b * w[4][3] + c[4][4].b * w[4][4] + c[4][5].b * w[4][5] + c[4][6].b * w[4][6] + c[4][7].b * w[4][7] + c[5][0].b * w[5][0] + c[5][1].b * w[5][1] + c[5][2].b * w[5][2] + c[5][3].b * w[5][3] + c[5][4].b * w[5][4] + c[5][5].b * w[5][5] + c[5][6].b * w[5][6] + c[5][7].b * w[5][7]
                             /*+ c[6][0].b*w[6][0]*/
                             + c[6][1].b * w[6][1] + c[6][2].b * w[6][2] + c[6][3].b * w[6][3] + c[6][4].b * w[6][4] + c[6][5].b * w[6][5] + c[6][6].b * w[6][6] + /*c[6][7].b*w[6][7]*/
                             /*+ c[7][0].b*w[7][0]  + c[7][1].b*w[7][1]*/ +c[7][2].b * w[7][2] + c[7][3].b * w[7][3] + c[7][4].b * w[7][4] + c[7][5].b * w[7][5] + /*c[7][6].b*w[7][6] +  c[7][7].b*w[7][7]*/ +round) /
                                total_alpha_weight,
                            0, 255);
            }
            dest.color(x, y, col);
    ...
    void upsizeCubicPlus(IntPtr elm_index) {
        ...
        if (NeedMultiChannel(src.type(), dest.type())) {
            ...
            FREPD(x, dest.lw()) // iterate forward so we can increase pointers
            {
                ...
                if (xi != xi2) {
                    xi = xi2;
                    Int xo_last = xi + CUBIC_PLUS_SAMPLES;
                    if (clamp)
                        Clamp(xo_last, 0, src.lw() - 1);
                    else
                        xo_last = Mod(xo_last, src.lw());
                ...
                REPAD(x, xo) {
                    ...
                    REPAD(y, yo) {
                        Flt w = xw + yw[y];
                        if (w < Sqr(CUBIC_PLUS_RANGE)) {
                            w = Weight(w * Sqr(CUBIC_PLUS_SHARPNESS));
                            Add(color, rgb, c[xc][y], w, alpha_weight);
                            weight += w;
                        }
                    }
                }
    ...
    void upsizeCubicFast(IntPtr elm_index) {
        ...
        if (NeedMultiChannel(src.type(), dest.type())) {
            ...
            FREPD(x, dest.lw()) // iterate forward so we can increase pointers
            {
                ...
                if (xi != xi2) {
                    xi = xi2;
                    Int xo_last = xi + CUBIC_FAST_SAMPLES;
                    if (clamp)
                        Clamp(xo_last, 0, src.lw() - 1);
                    else
                        xo_last = Mod(xo_last, src.lw());
        ...
        if (NeedMultiChannel(src.type(), dest.type())) {
            ...
            FREPD(x, dest.lw()) // iterate forward so we can increase pointers
            {
                ...
                REPAD(x, xo) {
                    Int xc = (x + x_offset) & 1;
                    REPAD(y, yo)
                    Add(color, rgb, c[xc][y], xw[x] * yw[y], alpha_weight);
                }
                Normalize(color, rgb, alpha_weight, alpha_limit);
                SetColor(dest_data_x, dest.type(), dest.hwType(), color);
                dest_data_x += dest.bytePP();
    ...
    CopyContext(C Image &src, Image &dest, FILTER_TYPE filter, UInt flags) : src(src), dest(dest),
                                                                             ...
                                                                             flags(flags),
                                                                             SetColor(ignore_gamma ? SetColorF : src_srgb ? SetColorS
                                                                                                                          : SetColorL) // pointer to function, when resizing we operate on source native gamma, so if source is sRGB then we're setting sRGB color, and if linear then linear
    {}
    Bool process(Int max_mip_maps, Flt sharp_smooth) {
        ...
        REPD(face, dest.faces()) {
            ...
            } else // resize
            {
                ...
                if (dest.lw() == Max(1, src.lw() >> 1) && dest.lh() == Max(1, src.lh() >> 1) && dest.ld() == Max(1, src.ld() >> 1) // 2x downsample
                    && !keep_edges && (Equal(sharp_smooth, 1) || filter == FILTER_NONE)) {
                    if (src.ld() <= 1) // 2D
                    {
                        switch (filter) {
                        case FILTER_NONE:
                ...
                // any scale
                {
                    ...
                    if (keep_edges) {
                        ...
                        x_mul_add.x = Flt(src.lw()) / dest.lw();
                        x_mul_add.y = x_mul_add.x * 0.5f - 0.5f;
                        y_mul_add.x = Flt(src.lh()) / dest.lh();
                        y_mul_add.y = y_mul_add.x * 0.5f - 0.5f;
                        z_mul_add.x = Flt(src.ld()) / dest.ld();
                        z_mul_add.y = z_mul_add.x * 0.5f - 0.5f;
                    }
                    area_size.set(x_mul_add.x, y_mul_add.x, z_mul_add.x);
                    area_size *= sharp_smooth;
                    if (filter != FILTER_NONE && (area_size.x > 1 + EPS || area_size.y > 1 + EPS) && src.ld() == 1 && dest.ld() == 1) // if we're downsampling (any scale is higher than 1) then we must use more complex 'areaColor*' methods
                    {
                        ...
                        if (linear_gamma) {
                            ...
                            {
                                if (src_srgb)
                                    manual_linear_to_srgb = true; // source is sRGB however we have linear color, so convert it back to sRGB
                                set_color = SetColorF;
                            } else
                                set_color = SetColorL; // write linear color, 'SetColorL' will perform gamma conversion
                        }
                        ImageThreads.init().process(dest.lh(), DownsizeArea, T);
                    } else if ((filter == FILTER_BEST || filter == FILTER_WAIFU) && ResizeWaifu && (dest.lw() > src.lw() || dest.lh() > src.lh()) && src.ld() == 1 && dest.ld() == 1 && ResizeWaifu(src, dest, flags)) {
                    } else
