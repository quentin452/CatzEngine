...
void GuiObj::notifyParentOfRectChange()
{
   ...
   if(parent())
   {
      Rect rect1(FLT_MAX, -FLT_MAX, FLT_MAX, -FLT_MAX);
      Rect rect2(-FLT_MAX, FLT_MAX, -FLT_MAX, FLT_MAX);
      parent()->childRectChanged(&rect1, &rect2, T); // this will trigger full reset
   }
}
/******************************************************************************/
