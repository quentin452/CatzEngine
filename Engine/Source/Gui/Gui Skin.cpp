...
void GuiSkin::Button::reset() {
    disabled_color = normal_color.set(255);
    disabled_color.a /= 2;
    pushed_disabled_color = pushed_color.set(192);
    pushed_disabled_color.a /= 2;
...
Bool GuiSkin::Menu::load(File &f, CChar *path) {
    ...
    case 0: {
        f >> normal_color >> check_color >> sub_menu_color >> padding;
        list_elm_height = 0.043f;
        normal.require(f._getAsset(), path);
...
void GuiSkin::TextLine::reset() {
    normal_panel_color = normal_text_color = disabled_panel_color = disabled_text_color.set(255);
    disabled_panel_color.a /= 2;
    disabled_text_color.a /= 2;
...
Bool GuiSkin::TextLine::load(File &f, CChar *path) {
    ...
    case 2: {
        f >> normal_panel_color >> normal_text_color >> disabled_panel_color >> disabled_text_color >> rect_color;
        text_size = 0.8f;
        normal.require(f.getAssetID(), path);
        disabled.require(f.getAssetID(), path);
        text_style.require(f.getAssetID(), path);
    ...
    case 0: {
        f >> normal_panel_color >> disabled_panel_color >> rect_color;
...
Bool GuiSkin::Window::load(File &f, CChar *path) {
    ...
    case 0: {
        f >> normal_color >> active_color >> text_size >> text_padd;
        button_offset.zero();
        normal.require(f._getAsset(), path);
