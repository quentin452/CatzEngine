      ...
      #endif
         {
            ...
            }else
            {
             C Vec //&v0=   edge_vtx0.pos,
               ...
               if( new_nrm.length2()<=Sqr(EPS)       // if new triangle surface is tiny (perhaps all 3 points are now on 1 line) then we won't be able to calculate triangle normal properly and it can cause issues with collision detection (raycast)
